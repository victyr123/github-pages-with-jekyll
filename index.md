...
body.body_new{min-width:1060px}
.wrapper_new{font-family:'Microsoft YaHei',Arial,sans-serif}
.wrapper_new #head{border-bottom:0;min-width:1060px;position:absolute}
.wrapper_new #head.s_down{box-shadow:0 2px 10px 0 rgba(0,0,0,.1)}
.wrapper_new #head.fix-head .s_form{height:40px}
.wrapper_new #head.fix-head #result_logo{margin-top:17px}
.wrapper_new #head.fix-head .fm{margin:15px 0 15px 19px}
.wrapper_new #head.fix-head .s_ipt_wr{height:36px}
.wrapper_new #head.fix-head #kw{height:38px}
.wrapper_new #head.fix-head .s_btn_wr .s_btn{height:40px;line-height:41px}
.wrapper_new .s_form{height:70px;padding-left:20px}
.wrapper_new #result_logo{margin:23px 0 0}
.wrapper_new .fm{margin:20px 0 20px 19px}
...
.wrapper_new .s_ipt_wr{width:558px;height:40px;border:2px solid #c4c7ce;border-radius:10px 0 0 10px;border-right:0;overflow:visible}
...
.wrapper_new input{outline:0;-webkit-appearance:none}
.wrapper_new .s_ipt{height:42px;font:16px/18px arial;padding:10px 0 12px 14px;margin:0;width:484px;background:transparent;border:0;outline:0;-webkit-appearance:none}
.wrapper_new.wrapper_l #kw.s_ipt{width:484px}
.wrapper_new .s_btn_wr{width:112px;position:relative;z-index:2;zoom:1;border:0}
.wrapper_new .s_btn_wr .s_btn{cursor:pointer;width:112px;height:44px;line-height:45px;line-height:44px\9;background-color:#4e6ef2;border-radius:0 10px 10px 0;font-size:17px;box-shadow:none;font-weight:400;border:0;outline:0;letter-spacing:normal}
...
.wrapper_new #s_tab{color:#626675;padding-top:74px;background:0 0;padding-left:140px}
.wrapper_new #s_tab a{color:#626675}
.wrapper_new #s_tab a,.wrapper_new #s_tab b{width:44px;margin-right:27px;line-height:28px;text-align:left}
...
.wrapper_new #s_tab .cur-tab:after{content:'';width:44px;height:2px;background:#4e6ef2;border-radius:1px;display:block;margin-top:1px}
...
.wrapper_new #u{height:60px;margin:12px 0 0;padding-right:24px}
.wrapper_new .fix-head #u{margin:5px 0 0}
...
.wrapper_new #page{background-color:#F5F5F6;margin:30px 0 0;padding-left:0}
.wrapper_new #page .page-inner{padding:14px 0 14px 140px}
.wrapper_new #page .fk{display:none}
.wrapper_new #page strong,.wrapper_new #page a{width:36px;height:36px;border:0;border-radius:6px;background-color:#fff;color:#3951B3;margin-right:12px}
.wrapper_new #page a .pc{border:0;width:36px;height:36px;line-height:36px}
.wrapper_new #page strong{background:#4E6EF2;color:#fff;font-weight:400}
.wrapper_new #page .n{width:80px;padding:0;line-height:36px}
.wrapper_new #page a:hover,.wrapper_new #page a:hover .pc,.wrapper_new #page .n:hover{border:0;background:#4E6EF2;color:#fff}
...
.wrapper_new #form .bdsug-new{width:558px;top:35px;border-radius:0 0 10px 10px;border:2px solid #4e71f2!important;border-top:0!important;box-shadow:none;font-family:'Microsoft YaHei',Arial,sans-serif;z-index:1}
.wrapper_new .fix-head.s_down #form .bdsug-new{top:31px}
...
.wrapper_new .soutu-env-new .soutu-layer .soutu-url-wrap,.wrapper_new .soutu-env-new .soutu-layer #soutu-url-kw{width:560px;height:44px}
.wrapper_new.wrapper_s .soutu-env-new .soutu-layer{width:560px}
.wrapper_new.wrapper_s .soutu-env-new .soutu-layer .soutu-url-wrap,.wrapper_new.wrapper_s .soutu-env-new .soutu-layer #soutu-url-kw{width:448px;height:44px}
.wrapper_new.wrapper_s .fix-head .soutu-env-new .soutu-layer .soutu-url-wrap,.wrapper_new.wrapper_s .fix-head .soutu-env-new .soutu-layer #soutu-url-kw,.wrapper_new .fix-head .soutu-env-new .soutu-layer .soutu-url-wrap,.wrapper_new .fix-head .soutu-env-new .soutu-layer #soutu-url-kw,.wrapper_new .fix-head .soutu-env-new .soutu-layer .soutu-url-btn-new{height:40px}
.wrapper_new .fix-head .soutu-env-new .soutu-layer .soutu-url-btn-new{line-height:41px}
.wrapper_new .soutu-env-new .soutu-layer .soutu-url-btn-new{width:112px}
...
.new-pmd .c-text{display:inline-block;padding:0 2px;text-align:center;vertical-align:middle;font-style:normal;color:#fff;overflow:hidden;line-height:16px;height:16px;font-size:12px;border-radius:2px;font-weight:200}
.new-pmd a.c-text{text-decoration:none;color:#fff!important}
.new-pmd a.c-text:visited{color:#fff!important}
...
.new-pmd .c-text-mult{padding:0 6px;line-height:18px;height:18px;border-radius:4px;font-weight:400}
.new-pmd .c-text-blue{background-color:#4E6EF2}
.new-pmd .c-text-blue-border{color:#4E6EF2;border:1px solid #CBD2FF;padding:0 8px;border-radius:4px;font-weight:400}
.new-pmd .c-text-green{background-color:#39b362}
.new-pmd .c-text-green-border{color:#39b362;border:1px solid #C9E7CD;padding:0 8px;border-radius:4px;font-weight:400}
.new-pmd .c-text-red{background-color:#f73131}
.new-pmd .c-text-red-border{color:#f73131;border:1px solid #F0C8BD;padding:0 8px;border-radius:4px;font-weight:400}
.new-pmd .c-text-yellow{background-color:#ffc20d}
.new-pmd .c-text-yellow-border{color:#ffc20d;border:1px solid #FCEDB1;padding:0 8px;border-radius:4px;font-weight:400}
.new-pmd .c-text-orange{background-color:#f60}
.new-pmd .c-text-orange-border{color:#f60;border:1px solid #F8D2B0;padding:0 8px;border-radius:4px;font-weight:400}
.new-pmd .c-text-pink{background-color:#fc3274}
.new-pmd .c-text-pink-border{color:#fc3274;border:1px solid #F6C4D7;padding:0 8px;border-radius:4px;font-weight:400}
.new-pmd .c-text-gray{background-color:#858585}
.new-pmd .c-text-gray-border{color:#858585;border:1px solid #DBDBDB;padding:0 8px;border-radius:4px;font-weight:400}
.new-pmd .c-text-dark-red{background-color:#CC2929}
.new-pmd .c-text-white-border{color:#fff;border:1px solid rgba(255,255,255,.8);padding:0 8px;border-radius:4px;font-weight:400}
.new-pmd .c-text-hot{background-color:#fc3274}
.new-pmd .c-text-new{background-color:#f73131}
.new-pmd .c-text-fei{background-color:#f60}
.new-pmd .c-text-bao{background-color:#CC2929}
...
.new-pmd .c-textarea{font:13px/21px 'Microsoft YaHei',Arial,sans-serif;color:#333;border:1px solid #D7D9E0;border-radius:6px;padding:5px 12px;resize:none;outline:0}
...
.new-pmd .c-link{color:#3951B3;text-decoration:none;cursor:pointer}
.new-pmd .c-link:hover{text-decoration:underline;color:#315EFB}
.new-pmd .c-link:visited{color:#771CAA}
.new-pmd .c-font-sigma{font:36px/60px 'Microsoft YaHei',Arial,sans-serif}
.new-pmd .c-font-large{font:20px/24px 'Microsoft YaHei',Arial,sans-serif}
.new-pmd .c-font-big{font:20px/24px 'Microsoft YaHei',Arial,sans-serif}
.new-pmd .c-font-special{font:16px/26px 'Microsoft YaHei',Arial,sans-serif}
.new-pmd .c-font-medium{font:14px/22px 'Microsoft YaHei',Arial,sans-serif}
.new-pmd .c-font-middle{font:14px/22px 'Microsoft YaHei',Arial,sans-serif}
.new-pmd .c-font-normal{font:13px/21px 'Microsoft YaHei',Arial,sans-serif}
.new-pmd .c-font-small{font:12px/20px 'Microsoft YaHei',Arial,sans-serif}
.new-pmd .c-font-family{font-family:'Microsoft YaHei',Arial,sans-serif}
...
.new-pmd .c-color-link{color:#3951B3}
.new-pmd .c-select{position:relative;display:inline-block;width:96px;box-sizing:border-box;-webkit-box-sizing:border-box;-moz-box-sizing:border-box;vertical-align:middle;color:#222;font:13px/21px 'Microsoft YaHei',Arial,sans-serif}
...
.new-pmd.c-container .t{font:20px/24px 'Microsoft YaHei',Arial,sans-serif;font-weight:400;margin-bottom:4px}
.new-pmd .c-abstract{font:13px/21px 'Microsoft YaHei',Arial,sans-serif;color:#333}
.new-pmd .cr-title{font:14px/22px 'Microsoft YaHei',Arial,sans-serif;color:#222;font-weight:400}
...
.new-pmd .c-border{border-radius:12px;border:0;margin:0 -16px;padding:12px 16px;width:auto;box-shadow:0 2px 10px 0 rgba(0,0,0,.1);-webkit-box-shadow:0 2px 10px 0 rgba(0,0,0,.1);-moz-box-shadow:0 2px 10px 0 rgba(0,0,0,.1);-o-box-shadow:0 2px 10px 0 rgba(0,0,0,.1)}
...
#container.sam_newgrid{font:13px/21px 'Microsoft YaHei',Arial,sans-serif}
#container.sam_newgrid td,#container.sam_newgrid th{font:13px/21px 'Microsoft YaHei',Arial,sans-serif}
...
@font-face{font-family:cicons;font-weight:400;font-style:normal;src:url(//m.baidu.com/se/static/font/cicon.eot?t=1592537806971#);src:url(//m.baidu.com/se/static/font/cicon.eot?t=1592537806971#iefix) format('embedded-opentype'),url(//m.baidu.com/se/static/font/cicon.woff?t=1592537806971#) format('woff'),url(//m.baidu.com/se/static/font/cicon.ttf?t=1592537806971#) format('truetype'),url(//m.baidu.com/se/static/font/cicon.svg?t=1592537806971#cicons) format('svg')}
@font-face{font-family:cIconfont;font-weight:400;font-style:normal;src:url(https:\/\/dss0.bdstatic.com/5aV1bjqh_Q23odCf/static/superman/font/iconfont-85bb622ea3.eot);src:url(https:\/\/dss0.bdstatic.com/5aV1bjqh_Q23odCf/static/superman/font/iconfont-85bb622ea3.eot?#iefix) format('embedded-opentype'),url(https:\/\/dss0.bdstatic.com/5aV1bjqh_Q23odCf/static/superman/font/iconfont-464a72a360.woff2) format('woff2'),url(https:\/\/dss0.bdstatic.com/5aV1bjqh_Q23odCf/static/superman/font/iconfont-5908ac049f.woff) format('woff'),url(https:\/\/dss0.bdstatic.com/5aV1bjqh_Q23odCf/static/superman/font/iconfont-819c4eaa4d.ttf) format('truetype'),url(https:\/\/dss0.bdstatic.com/5aV1bjqh_Q23odCf/static/superman/font/iconfont-a5cf551407.svg#iconfont) format('svg')}
...
<noscript>
	<meta http-equiv="refresh" content="0; url=/s?wd=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&oq=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&tn=baiduhome_pg&ie=utf-8&usm=2&rsv_idx=2&rsv_pq=b25baac30001622f&rsv_t=8d8dDKNikplVOgDijpkleYDcTP5dtSP66q6yXSvWRR8l2JONTuKk%2F42vEISQmYFHiR7w&rqlang=cn&nojs=1&bqid=b25baac30001622f"/>
</noscript>
...
<script>if(window.bds&&bds.util&&bds.util.setContainerWidth){bds.util.setContainerWidth();}</script><div id="head"><div class="head_wrapper"><div class="s_form"><div class="s_form_wrapper"><style>.index-logo-srcnew {display: none;}@media (-webkit-min-device-pixel-ratio: 2),(min--moz-device-pixel-ratio: 2),(-o-min-device-pixel-ratio: 2),(min-device-pixel-ratio: 2){.index-logo-src {display: none;}.index-logo-srcnew {display: inline;}}</style><div id="lg"><img hidefocus="true" src="//www.baidu.com/img/bd_logo1.png" width="270" height="129"></div><a href="/" id="result_logo"  onmousedown="return c({'fm':'tab','tab':'logo'})"><img class='index-logo-src' src="//www.baidu.com/img/flexible/logo/pc/result.png" alt="到百度首页" title="到百度首页"><img class='index-logo-srcnew' src="//www.baidu.com/img/flexible/logo/pc/result@2.png" alt="到百度首页" title="到百度首页"></a><form id="form" name="f" action="/s" class="fm "><input type="hidden" name="ie" value="utf-8"><input type="hidden" name="f" value="8"><input type="hidden" name="rsv_bp" value="1"><input type="hidden" name="rsv_idx" value="2"><input type=hidden name=ch value=""><input type=hidden name=tn value="baiduhome_pg"><input type=hidden name=bar value=""><span class="bg s_ipt_wr"><input id="kw" name="wd" class="s_ipt" value="乘客坐飞机拍到日环食" maxlength="255" autocomplete="off"></span><span class="bg s_btn_wr"><input type="submit" id="su" value="百度一下" class="bg s_btn"></span><span class="tools"><span id="mHolder"><div id="mCon"><span>输入法</span></div><ul id="mMenu"><li><a href="javascript:;" name="ime_hw">手写</a></li><li><a href="javascript:;" name="ime_py">拼音</a></li><li class="ln"></li><li><a href="javascript:;" name="ime_cl">关闭</a></li></ul></span></span><input type="hidden" name="oq" value="乘客坐飞机拍到日环食"><input type="hidden" name="rsv_pq" value="b25baac30001622f"><input type="hidden" name="rsv_t" value="8d8dDKNikplVOgDijpkleYDcTP5dtSP66q6yXSvWRR8l2JONTuKk/42vEISQmYFHiR7w"><input type="hidden" name="rqlang" value="cn"></form><div id="m"></div></div></div><div id="u"><a class="toindex" href="/">百度首页</a><a id="imsg" href="http://www.baidu.com/#"  onmousedown="return user_c({'fm':'set','tab':'imsg','login':'1'})">消息</a><a href="javascript:;" name="tj_settingicon" class="pf">设置<i class="c-icon c-icon-triangle-down"></i></a><a href="http://i.baidu.com" id="user" class="username">380687986<i class="c-icon"></i></a></div><div id="u1"><a href="https://voice.baidu.com/act/newpneumonia/newpneumonia/?from=osari_pc_1" name="tj_trvirus" id="virus-2020" class="mnav sp">抗击肺炎</a><a href="http://news.baidu.com" name="tj_trnews" class="mnav">新闻</a><a href="https://www.hao123.com" name="tj_trhao123" class="mnav">hao123</a><a href="http://map.baidu.com" name="tj_trmap" class="mnav">地图</a><a href="http://v.baidu.com" name="tj_trvideo" class="mnav">视频</a><a href="http://tieba.baidu.com" name="tj_trtieba" class="mnav">贴吧</a><a href="http://xueshu.baidu.com" name="tj_trxueshu" class="mnav">学术</a><a href="http://i.baidu.com" class="username">380687986</a><a href="http://www.baidu.com/gaoji/preferences.html" name="tj_settingicon" class="pf">设置</a><a href="http://www.baidu.com/more/" name="tj_briicon" class="bri" style="display: block;">更多产品</a></div></div></div>
...
<!--cxy_all+baiduhome_pg+d8a66c2e5671dd68f19db129ada4dca7+000000000000000000000000000000000192349-->
                                                     ...
                                                     <div class="s_tab" id="s_tab"><div class="s_tab_inner"><b class="cur-tab">网页</b><a href="https://www.baidu.com/s?rtt=1&bsst=1&cl=2&tn=news&word=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F" wdfield="word"  onmousedown="return c({'fm':'tab','tab':'news'})" sync="true" class="s-tab-item s-tab-news">资讯</a><a href="/sf/vsearch?pd=video&tn=vsearch&lid=b25baac30001622f&ie=utf-8&wd=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&rsv_spt=7&rsv_bp=1&f=8&oq=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&rsv_pq=b25baac30001622f&rsv_t=50e8ML8PbnAy7W1GkvRzxbllEpBZvf2cXtag94mQrAMLs6XQ4IHgGBOhMBUXpqJdlB1H"  onmousedown="return c({'fm':'tab','tab':'video'})"  class="s-tab-item s-tab-video">视频</a><a href="http://image.baidu.com/i?tn=baiduimage&ps=1&ct=201326592&lm=-1&cl=2&nc=1&ie=utf-8&word=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F" wdfield="word"  onmousedown="return c({'fm':'tab','tab':'pic'})"  class="s-tab-item s-tab-pic">图片</a><a href="http://zhidao.baidu.com/q?ct=17&pn=0&tn=ikaslist&rn=10&fr=wwwt&word=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F" wdfield="word"  onmousedown="return c({'fm':'tab','tab':'zhidao'})"  class="s-tab-item s-tab-zhidao">知道</a><a href="http://wenku.baidu.com/search?lm=0&od=0&ie=utf-8&word=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F" wdfield="word"  onmousedown="return c({'fm':'tab','tab':'wenku'})"  class="s-tab-item s-tab-wenku">文库</a><a href="http://tieba.baidu.com/f?fr=wwwt&kw=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F" wdfield="kw"  onmousedown="return c({'fm':'tab','tab':'tieba'})"  class="s-tab-item s-tab-tieba">贴吧</a><a href="https://b2b.baidu.com/s?fr=wwwt&q=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F" wdfield="q"  onmousedown="return c({'fm':'tab','tab':'b2b'})"  class="s-tab-item s-tab-b2b">采购</a><a href="https://map.baidu.com/?newmap=1&ie=utf-8&s=s%26wd%3D%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F"  onmousedown="return c({'fm':'tab','tab':'map'})"  class="s-tab-item s-tab-map">地图</a><a href="http://www.baidu.com/more/"  onmousedown="return c({'fm':'tab','tab':'more'})"  class="s-tab-item s-tab-more">更多»</a></div>
</div>
		...
		<![endif]-->
			...
			<style>
			    											 .op-timeliness-summary{text-indent:2em}.op_timeliness_news_subtitle{font-size:1.077em}.op-timeliness-news-ul a{float:left;background:url(//www.baidu.com/aladdin/img/timeliness_news/icon.gif) no-repeat left center;padding-left:10px}.op-timeliness-news-ul span{float:right;color:#666}.op-timeliness-news-dl dd{float:left;position:relative;overflow:hidden}.op-timeliness-news-dl dd span{background:#000;text-align:center;opacity:.65;-moz-opacity:.65;-webkit-opacity:.65;-ms-opacity:.65;filter:alpha(opacity=65);display:block;position:absolute;left:0;bottom:0;height:30px;line-height:30px;width:100%}.op-timeliness-news-dl dd em{display:block;position:absolute;left:0;bottom:0;height:30px;line-height:30px;color:#fff;width:100%;text-align:center;text-decoration:none}.op_timeliness_news_title{font-size:1.69em;line-height:100%}.op-timeliness-outer{width:320px;height:160px;position:relative;overflow:hidden}.op-timeliness-inner{width:960px;height:160px;position:absolute;top:0;left:0}.op-timeliness-inner div{position:relative;width:320px;height:160px;float:left;overflow:hidden;z-index:9}.op-timeliness-inner div span{position:absolute;right:0;top:0;width:36px;height:22px;line-height:22px;display:block;background:#f54040;color:#fff;text-align:center;font-size:1em;z-index:10}.op-timeliness-inner div.op-timeliness-news-txt{position:absolute;bottom:0;left:0;opacity:.65;-moz-opacity:.65;-webkit-opacity:.65;-ms-opacity:.65;filter:alpha(opacity=65);background:#000;color:#fff;height:30px;line-height:30px;width:100%;z-index:10}.op-timeliness-inner div em{color:#fff;height:30px;line-height:30px;display:block;position:absolute;bottom:0;left:0;padding-left:10px;z-index:11;width:70%;text-decoration:none;cursor:pointer}.op-timeliness-outer ul{margin:0;padding:0;list-style:none;position:absolute;right:20px;bottom:0;height:25px;z-index:12}.op-timeliness-outer ul li{float:left;margin-right:6px;cursor:pointer}.op-timeliness-left a,.op-timeliness-right a{display:block;width:32px;height:32px;background:url(//www.baidu.com/aladdin/img/timeliness_news/icon_sword_original.gif) 0 -32px no-repeat;cursor:pointer;position:absolute;top:63px;z-index:10}.op-timeliness-left a{left:10px}.op-timeliness-right a{right:10px;background-position:0 0}.op-timeliness-left a:hover,.op-timeliness-right a:hover{background-color:#5c5c5c}.op-timeliness-new-from{text-align:left}.op-timeline-news-border{border:2px solid red;padding-left:8px;padding-right:8px}.op-timeline-news2-subtitle{font-size:1.69em;line-height:100%}.op-timeline-news2-subtitle a,.op-timeline-news2-subtitle a:active,.op-timeline-news2-subtitle a:hover,.op-timeline-news2-subtitle a:visited{text-decoration:none}.op_timeliness-news-content{position:relative}.c-border .op-timeliness-new-from{margin-top:7px}.op-timeliness-video{width:100%;background-color:#000;margin-bottom:10px;display:none;height:290px}.op-timeliness-video:focus{outline:0}.op-timeliness-video-container{position:relative;display:block;text-decoration:none;zoom:1}.op-timeliness-title{line-break:anywhere;font-family:PingFangSC-Regular;font-size:20px;color:#00C;line-height:30px}.op-timeliness-abs{font-family:PingFangSC-Regular;font-size:13px;color:#333;line-height:21px;margin-top:3.5px}.op-timeliness-source{font-family:PingFangSC-Regular;font-size:13px;color:#080;line-height:13px;margin-top:3.5px}.op-timeliness-time{font-family:PingFangSC-Regular;font-size:13px;color:#666;text-align:right;line-height:13px}.op-timeliness-img-container{position:relative;display:block;text-decoration:none;zoom:1;width:276px;height:154px;margin-right:10px;foverflow:hidden}.op-timeliness-img{width:100%;height:100%;overflow:hidden}.op-timeliness-abs-video{font-family:PingFangSC-Regular;font-size:13px;color:#333;margin-top:2.5px;line-height:21px}.op-timeliness-click-area{position:relative;z-index:2;width:100%;-webkit-background-size:cover;background-size:cover;outline:0!important;margin-bottom:10px;height:290px}.op-timeliness-click-area ::after{content:'';display:block;height:100%;background:rgba(0,0,0,.1)}.op-timeliness-video-play-icon{position:absolute;top:50%;left:50%;display:block;width:44px;height:44px;margin-top:-30px;margin-left:-30px;border-radius:50%;outline:0!important;border:none;cursor:pointer}.op-timeliness-video-label{float:right;right:6px;background:rgba(0,0,0,.5);border-radius:30px;padding:3px 8px;font-size:12px;color:#FFF;line-height:12px;position:absolute;bottom:6px}.source-icon{vertical-align:middle;width:14px;height:14px;border:1px solid #eee;border-radius:100%;margin-right:5px;margin-top:-3px}.op_sp_realtime_group_img{margin-right:10px}.op_sp_realtime_group_title{font-family:PingFangSC-Regular;font-size:16px;color:#00C}.op_sp_realtime_group_title_text{display:block;line-height:18px}.op_sp_realtime_subabs{font-family:PingFangSC-Regular;font-size:13px;color:#333;line-height:20px;margin-top:3px}.op_sp_realtime_subabs em{color:#333}.op_sp_realtime_group_source{font-family:PingFangSC-Regular;font-size:13px;color:#080;margin-top:3px;line-height:16px}.op_sp_realtime_group_source_wrapper{text-decoration:none}.op_sp_realtime_group_source_time{font-family:PingFangSC-Regular;font-size:13px;color:#666;text-align:right;line-height:13px}.op_sp_realtime_group_gap{margin-bottom:12px}.op_sp_realtime_bigpic5_img_con{position:relative}.op_sp_realtime_bigpic5_subTitle_0{font-size:1.69em;font-family:Microsoft YaHei;font-weight:400;line-height:22px}.op_sp_realtime_bigpic5_imgTitle{text-decoration:none;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;position:absolute;bottom:0;left:0;width:100%;color:#fff;height:30px;line-height:31px;text-indent:10px;filter:progid:DXImageTransform.Microsoft.gradient(enabled='true', startColorstr='#99000000', endColorstr='#99000000');background-color:rgba(0,0,0,.6)}:root .op_sp_realtime_bigpic5_imgTitle{filter:none;background-color:rgba(0,0,0,.6)}.op_sp_realtime_bigpic5_imgTitle span:hover{text-decoration:underline}.op_sp_realtime_bigpic5_img_con_icon{position:absolute;top:0;right:0;padding:5px}.op_sp_realtime_bigpic5_first_abs{text-indent:2em}.op_sp_realtime_bigpic5_list{padding-top:6px}.op_sp_realtime_bigpic5_list div{line-height:1.7}.op_sp_realtime_bigpic5_list_last span{padding-bottom:5px}.op_sp_realtime_bigpic5_list_date{float:left;padding-right:10px;*padding-right:0;margin-right:8px;border-right:1px solid #ddd;display:inline}.op_sp_realtime_bigpic5_list_info{clear:right}.op_sp_realtime_bigpic5_more-cont-date{display:block;position:relative}.op_sp_realtime_bigpic5_more-cont-dot{display:inline-block;width:5px;height:12px;position:absolute;right:-13px;*right:-3px;_right:-2px;top:4px;*top:0;background:#fff url(//www.baidu.com/aladdin/img/right_timeline/timeline-1.1.png) no-repeat -59px 0;_background-position:-58px 0}.op_sp_realtime_bigpic5_more-cont-date{float:right;width:65px;text-align:right;overflow:hidden;white-space:nowrap;text-overflow:ellipsis}.op_sp_realtime_bigpic5_subTitle_con{text-overflow:ellipsis;white-space:nowrap;width:100%}.op_sp_realtime_bigpic5_preBox{text-decoration:none;position:relative;overflow:hidden}.op_sp_realtime_bigpic5_preBox img{vertical-align:top;float:left;height:81px}.op_sp_realtime_bigpic5_preBox b,.op_sp_realtime_bigpic5_preBox span{display:block;position:absolute;bottom:0;left:1px;height:20px;cursor:pointer}.op_sp_realtime_bigpic5_preBox span{display:block;background:#000;opacity:.65;filter:alpha(opacity=65);width:119px}.op_sp_realtime_bigpic5_preBox b{font:400 13px/20px arial;color:#fff;background:url(//www.baidu.com/aladdin/img/sp_realtime/play-1.0.png) no-repeat 4px center;padding-left:20px}.source-icon{vertical-align:middle;width:14px;height:14px;border:1px solid #eee;border-radius:100%;margin-right:5px;margin-top:-3px}.op-short-video-pc{line-height:21px}.op-short-video-pc-gap{margin-top:6px}.op-short-video-pc-link{position:relative;display:block;text-decoration:none;zoom:1}.op-short-video-pc-title{display:block;overflow:hidden;white-space:normal;word-break:break-all;word-wrap:break-word}.op-short-video-pc-play-icon{position:absolute;left:50%;top:50%;margin-top:-15px;margin-left:-15px;width:30px;height:30px}.op-short-video-pc-img{height:91px}.op-short-video-pc-img-group{width:100%;height:auto;max-height:92px}.op-short-video-pc-source{color:#999}.op-short-video-pc-duration-wrap{position:absolute;bottom:4px;right:4px;height:18px;padding:0 6px;line-height:18px;background:rgba(0,0,0,.4);filter:progid:DXImageTransform.Microsoft.gradient(startcolorstr=#66000000, endcolorstr=#66000000) -webkit-border-radius:9px;-moz-border-radius:9px;border-radius:9px;font-size:13px;color:#fff;text-align:center}.op-short-video-pc-title-medical{text-decoration:none}.op-short-video-pc-doctor{color:#999}.op-short-video-pc-doctor-name{margin-right:8px}.op-short-video-pc-hospital{white-space:nowrap;color:#999;padding-right:35px}.op-short-video-pc-hospital-name{max-width:100%;display:inline-block;vertical-align:middle}.op-short-video-pc-hospital-level{padding-left:1px;vertical-align:middle;border:1px solid #e3e3e3;color:#999}.op-short-video-pc-clamp1{white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.op-short-video-pc-single-result{margin-top:-4px}.op-short-video-pc-single-hospital-name{margin-right:8px}.op-short-video-pc-img-container{width:25%;padding-left:10px;margin-right:0;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box}.opr-toplist1-title{position:relative;margin-bottom:.5px}.opr-toplist1-table .opr-toplist1-right{text-align:right;white-space:nowrap}.opr-toplist1-table .c-index{min-width:14px;width:auto}.opr-toplist1-from{text-align:right}.opr-toplist1-from a{text-decoration:none}.opr-toplist1-new{position:relative;top:1px}.opr-toplist1-st{margin-bottom:2px;margin-left:3px}.opr-toplist1-update{float:right}.opr-toplist1-refresh{font-size:13px;font-weight:400;text-decoration:none}.opr-toplist1-refresh .opr-toplist1-icon{background:url(//www.baidu.com/aladdin/tpl/right_toplist1/refresh.png) 0 0/100% 100% no-repeat;margin-left:3px;width:16px;height:16px}.container_s .opr-toplist1-right-hot{display:none}.opr-toplist1-cut{white-space:nowrap;text-overflow:ellipsis;overflow:hidden;vertical-align:middle;display:inline-block}.container_s .opr-toplist1-cut{max-width:217px}.container_l .opr-toplist1-cut{max-width:247px}
								    			</style>
	 ...
	 <script id="head_script">
        ...
        bds.comm.queryEnc = "%B3%CB%BF%CD%D7%F8%B7%C9%BB%FA%C5%C4%B5%BD%C8%D5%BB%B7%CA%B3";
        bds.comm.queryId = "b25baac30001622f";
        bds.comm.inter = "";
        bds.comm.resTemplateName = "baidu";
        bds.comm.sugHost = "https://sp0.baidu.com/5a1Fazu8AA54nxGko9WTAnF6hhy/su";
        bds.comm.ishome = 0;
        bds.comm.query = "乘客坐飞机拍到日环食";
        bds.comm.qid = "b25baac30001622f";
        bds.comm.eqid = "b25baac30001622f000000065eef7afa";	
        bds.comm._se_click_track_flag = "";	
        bds.comm.cid = "0";
        bds.comm.sid = "32097_1458_31670_21098_31660_32046_31321_30823_32107";
        bds.comm.sampleval = [];
        bds.comm.stoken = "545fe5771258f872a8188cc0b7d58374";
        bds.comm.serverTime = "1592752890";
        bds.comm.user = "380687986";
        bds.comm.username = "380687986";
        bds.comm.isUserLogin = "1";
        bds.comm.userid = bds.comm.isUserLogin;
		bds.comm.__rdNum = "2518";
        bds.comm.useFavo = "";
        bds.comm.pinyin = "chengkezuofeijipaidaorihuanshi";
        bds.comm.favoOn = "";
        bds.comm.speedInfo = "[{\"ModuleId\":9537,\"TimeCost\":113.89,\"TimeSelf\":17.16},{\"ModuleId\":9540,\"TimeCost\":-1,\"TimeSelf\":-1,\"Idc\":\"6\"},{\"ModuleId\":9527,\"TimeCost\":91.09,\"TimeSelf\":44.12,\"isHitCache\":true,\"SubProcess\":[{\"ProcessId\":9531,\"TimeCost\":0,\"isHitCache\":true},{\"ProcessId\":9536,\"TimeCost\":10.04,\"isHitCache\":false},{\"ProcessId\":9535,\"TimeCost\":15.06,\"isHitCache\":false},{\"ProcessId\":9532,\"TimeCost\":31.91}]}]";
        bds.comm.topHijack = null;
        bds.comm.isDebug = false;
				bds.comm.personalData = {"sugSet":{"value":"","ErrMsg":"NOFOUND"},"sugStoreSet":{"value":"","ErrMsg":"NOFOUND"},"skinName":{"value":"","ErrMsg":"NOFOUND"},"fullSkinName":{"value":"0","utime":"","ErrMsg":"SUCCESS"},"customOpacity":{"value":"{\"2\":\"20\",\"18\":\"30\",\"42\":\"20\",\"46\":\"20\"}","utime":"","ErrMsg":"SUCCESS"},"skinHistory":{"value":"2:46:42:1:3:65","utime":"","ErrMsg":"SUCCESS"},"customLogo":{"value":"","ErrMsg":"NOFOUND"},"isSuper":{"value":"","ErrMsg":"NOFOUND"},"lastUploadPic":{"value":"","ErrMsg":"NOFOUND"},"userCards":{"value":"{\"_sort_card\":true,\"15\":\"on\",\"10\":\"on\",\"5\":\"off\",\"6\":\"off\",\"7\":\"off\",\"8\":\"off\",\"12\":\"off\",\"13\":\"off\",\"18\":\"off\",\"19\":\"off\",\"2\":\"off\",\"1\":\"off\",\"20\":\"off\",\"3\":\"off\"}","utime":1553769065,"ErrMsg":"SUCCESS"},"curCard":{"value":"100","utime":1553769083,"ErrMsg":"SUCCESS"},"delCard":{"value":"","ErrMsg":"NOFOUND"},"click_site":{"value":"a:2:{i:0;s:19:\"13075694&2625389464\";i:1;s:16:\"5297313&88551115\";}","utime":"","ErrMsg":"SUCCESS"},"xingzuo":{"value":"","ErrMsg":"NOFOUND"},"use_firstcard":{"value":"","ErrMsg":"NOFOUND"},"soccer":{"value":"","ErrMsg":"NOFOUND"},"worldcup_str":{"value":"","ErrMsg":"NOFOUND"},"worldcup_reward":{"value":"","ErrMsg":"NOFOUND"},"worldcup_win":{"value":"","ErrMsg":"NOFOUND"},"showAllTab":{"value":"on","utime":"","ErrMsg":"SUCCESS"},"lotterytab":{"value":"","ErrMsg":"NOFOUND"},"stock":{"value":"","ErrMsg":"NOFOUND"},"skinOpacity":{"value":"","ErrMsg":"NOFOUND"},"worldcup_extra":{"value":"","ErrMsg":"NOFOUND"},"closeCardSceneRec":{"value":"0","utime":1553769083,"ErrMsg":"SUCCESS"},"imeSwitch":{"value":"","ErrMsg":"NOFOUND"},"resultNum":{"value":"","ErrMsg":"NOFOUND"},"resultLang":{"value":"","ErrMsg":"NOFOUND"},"isSwitch":{"value":"","ErrMsg":"NOFOUND"},"scholarMessage":{"value":"","ErrMsg":"NOFOUND"},"skinOpen":{"value":"","ErrMsg":"NOFOUND"},"pdSearch":{"value":"","ErrMsg":"NOFOUND"},"scholarStatusNo":{"value":"","ErrMsg":"NOFOUND"},"searchsubclose":{"value":"","ErrMsg":"NOFOUND"},"cardsFrom":{"value":"{\"2\":1,\"4\":1,\"1\":1,\"3\":1}","utime":1553769065,"ErrMsg":"SUCCESS"},"scholarUserLevel":{"value":"","ErrMsg":"NOFOUND"},"isJumpHttps":{"value":"","ErrMsg":"NOFOUND"},"duRobotState":{"value":"","ErrMsg":"NOFOUND"},"city_weather":{"value":"","ErrMsg":"NOFOUND"},"switchHttps":{"value":"","ErrMsg":"NOFOUND"},"switchUpload":{"value":"","ErrMsg":"NOFOUND"},"personalSwitch":{"value":"","ErrMsg":"NOFOUND"},"switchPhoneNum":{"value":"","ErrMsg":"NOFOUND"},"switchIdCard":{"value":"","ErrMsg":"NOFOUND"},"errno":0,"trafficSet":{"value":"","ErrMsg":"NOFOUND"},"scholarLib":{"value":"","ErrMsg":"NOFOUND"},"yaohaoSet":{"value":"","ErrMsg":"NOFOUND"},"trafficLicenseSetV1":{"value":"","ErrMsg":"NOFOUND"}};
        ...
        bds.comm.iaurl=["208realtime.operation_card.aladdin.com","http:\/\/news.fznews.com.cn\/dsxw\/20200621\/5eef2fb662fe7.shtml","http:\/\/k.sina.com.cn\/article_6183820694_m170959d96033013xpx.html"];

		bds.comm.curResultNum = "12";
	...
	bds.comm.encTn = '50e8ML8PbnAy7W1GkvRzxbllEpBZvf2cXtag94mQrAMLs6XQ4IHgGBOhMBUXpqJdlB1H';		
        ...
        bds.comm.seinfo = {'fm':'se','T':'1592752890','y':'AFBD76FD','rsv_cache': (bds.se.mon.srvt>0)?0:1 };
        bds.comm.cgif = "https://sp0.baidu.com/9foIbT3kAMgDnd_/c.gif?t=0&q=%B3%CB%BF%CD%D7%F8%B7%C9%BB%FA%C5%C4%B5%BD%C8%D5%BB%B7%CA%B3&p=0&pn=1";

		bds.comm.upn = {"browser":"chrome","os":"windows","win":"win7","browsertype":"chrome"};
        bds.comm.cookie = {"BIDUPSID":"65C0E3E09ECE3D8C3D5300738084B4B9","PSTM":"1568473146","BAIDUID":"638857F8DFF03DB3835AE6C8C41BA57B:FG=1","MSA_WH":"375_812","BDICON":"10294984.98","H_WISE_SIDS":"146747_147208_142019_148321_147089_141744_147894_148194_148867_147684_148713_147280_148002_148824_148643_147827_148438_148754_147888_146573_148524_147346_127969_146037_147239_147351_148206_146652_147024_146732_138426_145997_131423_146499_114553_142206_146900_107311_146849_143507_144966_149278_145607_148662_146785_148345_148049_148425_147547_146053_145395_148869_146793_110085","BD_UPN":"12314353","BDSFRCVID":"iH-OJeC62lCHPlvuTU-uboLQDnyuYgJTH6aouQj7HpJkn7LWjt_EEG0PoU8g0KubAAvGogKK3gOTH4AF_2uxOjjg8UtVJeC6EG0Ptf8g0f5","H_BDCLCKID_SF":"tb4eVCDhtK_3fP36qRrEhtLH-q3jetJyaR30aT6vWJ5TMCo1LU7mhbK03b_L-4jyBN6RWtTayR3kShPC-tnh0tTWyh3Za-CfBNvBLU7N3l02Vb7ae-t2ynLVLtQq0-RMW20e0h7mWIbNsxA45J7cM4IseboJLfT-0bc4KKJxbnLWeIJIjj6jK4JKDGA8tjoP","BDORZ":"B490B5EBF6F3CD402E515D22BCDA1598","H_PS_PSSID":"32097_1458_31670_21098_31660_32046_31321_30823_32107","delPer":"0","BD_CK_SAM":"1","PSINO":"7","H_PS_645EC":"26efHYANGrZAAsM4NaeJhvxhp2P+2bFaF+WjtzEpLtEBLk+EV2qpRiC1R4WaxSNycZn0","BDSVRTM":"0"};
...
<div class="FYB_RD">
    ...
    <table class="c-table opr-toplist1-table">
                    ...
                    <tr>
                                                                                                                                                            ...
                                                                                                                                                            <
tn=baiduhome_pg&usm=1&rsv_idx=2&ie=utf-8&rsv_cq=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&rsv_dl=0_right_fyb_pchot_20811_01&rsf=bfd6251463a926514ee4f87200a7afb1_11_20_18" class="opr-toplist1-cut">小李子为女友庆生</a></span></td>
                <td class="opr-toplist1-right opr-toplist1-right-hot">233万<i class="opr-toplist1-st c-icon "></i></td>
            </tr>
                                    <tr>
                                                                                                                                                                                                            
                                                                                                                                                            <td><span><span class="c-index  c-gap-icon-right-small">19</span><a target="_blank" title="王子异方否认恋情" href="/s?wd=%E7%8E%8B%E5%AD%90%E5%BC%82%E6%96%B9%E5%90%A6%E8%AE%A4%E6%81%8B%E6%83%85&tn=baiduhome_pg&usm=1&rsv_idx=2&ie=utf-8&rsv_cq=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&rsv_dl=0_right_fyb_pchot_20811_01&rsf=bfd6251463a926514ee4f87200a7afb1_11_20_19" class="opr-toplist1-cut">王子异方否认恋情</a></span><span class="c-text c-text-danger c-gap-icon-left-small opr-toplist1-new">新</span></td>
                <td class="opr-toplist1-right opr-toplist1-right-hot">202万<i class="opr-toplist1-st c-icon "></i></td>
            </tr>
                                    <tr>
                                                                                                                                                                                                            
                                                                                                                                                            <td><span><span class="c-index  c-gap-icon-right-small">20</span><a target="_blank" title="黄子韬吃娃娃菜把牙吃断" href="/s?wd=%E9%BB%84%E5%AD%90%E9%9F%AC%E5%90%83%E5%A8%83%E5%A8%83%E8%8F%9C%E6%8A%8A%E7%89%99%E5%90%83%E6%96%AD&tn=baiduhome_pg&usm=1&rsv_idx=2&ie=utf-8&rsv_cq=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&rsv_dl=0_right_fyb_pchot_20811_01&rsf=bfd6251463a926514ee4f87200a7afb1_11_20_20" class="opr-toplist1-cut">黄子韬吃娃娃菜把牙吃断</a></span></td>
                <td class="opr-toplist1-right opr-toplist1-right-hot">182万<i class="opr-toplist1-st c-icon "></i></td>
            </tr>
                </tbody>
                                <tbody style="display:none">
                    <tr>
                                                                                                                                                                                                            
                                                                                                                                                            <td><span><span class="c-index  c-gap-icon-right-small">21</span><a target="_blank" title="任重自曝真实体重" href="/s?wd=%E4%BB%BB%E9%87%8D%E8%87%AA%E6%9B%9D%E7%9C%9F%E5%AE%9E%E4%BD%93%E9%87%8D&tn=baiduhome_pg&usm=1&rsv_idx=2&ie=utf-8&rsv_cq=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&rsv_dl=0_right_fyb_pchot_20811_01&rsf=bfd6251463a926514ee4f87200a7afb1_21_30_21" class="opr-toplist1-cut">任重自曝真实体重</a></span></td>
                <td class="opr-toplist1-right opr-toplist1-right-hot">175万<i class="opr-toplist1-st c-icon "></i></td>
            </tr>
                                    <tr>
                                                                                                                                                                                                            
                                                                                                                                                            <td><span><span class="c-index  c-gap-icon-right-small">22</span><a target="_blank" title="高校送毕业生7300份口红" href="/s?wd=%E9%AB%98%E6%A0%A1%E9%80%81%E6%AF%95%E4%B8%9A%E7%94%9F7300%E4%BB%BD%E5%8F%A3%E7%BA%A2&tn=baiduhome_pg&usm=1&rsv_idx=2&ie=utf-8&rsv_cq=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&rsv_dl=0_right_fyb_pchot_20811_01&rsf=bfd6251463a926514ee4f87200a7afb1_21_30_22" class="opr-toplist1-cut">高校送毕业生7300份口红</a></span></td>
                <td class="opr-toplist1-right opr-toplist1-right-hot">169万<i class="opr-toplist1-st c-icon "></i></td>
            </tr>
                        </tbody>    </table>
    </div>
...
<script type="text/javascript">
	...
	bds.comm.search_tool.oneDay = "1592666490";
	bds.comm.search_tool.oneWeek = "1592148090";
	bds.comm.search_tool.oneMonth = "1590074490";
	bds.comm.search_tool.oneYear = "1561130490";
	bds.comm.search_tool.thisDay = "1592582400";
	bds.comm.search_tool.thisWeek = "1592064000";
	bds.comm.search_tool.thisMonth = "1589990400";
	bds.comm.search_tool.thisYear = "1561046400";
...
<div class="result-op c-container c-group c-group-top xpath-log"  srcid="208"  id="1" tpl="timeliness_news2" mu="208realtime.operation_card.aladdin.com" data-op="{'y':'7BAF37BE'}" data-click="{'p1':'1','rsv_bdr':'','fm':'alop',rsv_stl:'1'}">
            

<style>
    .op_timeliness-img{height:160px;width:320px;overflow:hidden;}
    .op-timeliness-news-dl dd span{width:121px;}
    .op_timeliness-video{height:160px;width:320px;overflow:hidden;}
    .op-timeliness-source-wrapper{text-decoration: none;}
</style>
    <div class="c-row">
        <div class="c-span15 op-timeliness-img-container">
            <a href="https://baijiahao.baidu.com/s?id=1670095771404101011&wfr=content" target="_blank">
                                    <img class="op-timeliness-video-play-icon" src="//www.baidu.com/aladdin/tpl/timeliness_news2/play.790e5038.png" data-click="{fm:'video'}">
                                <img class="c-img op-timeliness-img" src="https://dss0.baidu.com/6ONWsjip0QIZ8tyhnq/it/u=3952815054,3892429267&fm=55&app=54&f=JPEG?w=1140&h=640" />
            </a>
        </div>
        <div class="c-span-last">
            <span class="op-timeliness-title">
                <a href="https://baijiahao.baidu.com/s?id=1670095771404101011&wfr=content" target="_blank"><em>乘客坐飞机拍到日环食</em></a>
            </span>
                            <p class="op-timeliness-abs">6月21日，最值得期待的天象“日环食”如约上演。有乘客坐飞机时，拍到了罕见的日环食，巨大的圆形阴影在云海上缓缓划过，十分壮观。</p>
                        <a class="op-timeliness-source-wrapper" href="https://baijiahao.baidu.com/s?id=1670095771404101011&wfr=content" target="_blank">
                <div class="op-timeliness-source">
                                                                <span class="op-timeliness-source-title">燃新闻视频</span>
                                                                <span class="op-timeliness-time">7小时前</span>
                                    </div>
            </a>
        </div>
    </div>
...
<div class="result-op c-container c-group c-group-middle xpath-log"  srcid="19"  id="2" tpl="sp_realtime_bigpic5" mu="https://www.baidu.com/s?tn=news&rtt=1&bsst=1&wd=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&cl=2" data-op="{'y':'FFF7F79F'}" data-click="{'p1':'2','rsv_bdr':'','fm':'alop',rsv_stl:'5'}">
            
                                    <h3 class="t c-group-title">
                                                                            <a href="http://www.baidu.com/link?url=_ho7lLR0cCQ-mzBq2h2B35SqPjTks-E8E03DT7qzhYSO-9UVFXi096xzN8Cmp1YMbZKBbhTJkLSuKfc5FonvQT7YkvFXnkfjJJWmij8Z9d7Y9fHwB6YrcR21i5tDLtdL0hZuABjnulPpM3EUnywGVlhE3iYbRU0FzFPojXuQ6AYXnXvqk68msbU3XYJxkFogCJN5AGM0xM3t8rrpL3ksf92CCLDvtqhtPSelMGthGtm" target="_blank">
                        资讯
        </a>
        ...
        <div>
                                    ...
                                    <div class="c-row op_sp_realtime_group_top op_sp_realtime_group_gap">
                                                <div class="op_sp_realtime_group_title">
                            <a class="op_sp_realtime_group_title_text" href="http://www.baidu.com/link?url=yME3SkFtKB-dwfScA8ApgPhX8mctv0AXALxiJNVmdqGx_6fzd_N0s_cFjV0RoinaDIlByE4JLHAvxWw2ggBZWK" target="_blank" >
                                                                    视频:<em>乘客坐飞机拍到日环食</em>,太壮观了
                                                            </a>
                            <div class="op_sp_realtime_subabs">
                                                                    6月21日夏至日,“超级<em>日环食</em>”震撼登场,我国刚好处于绝佳的观测位置。本次<em>日环食</em>非常接近全食,也被称为“金边日食”。有网友晒出<em>乘客飞机拍到</em>的<em>日环食</em>,太壮观了。
                                                            </div>
                            <a class="op_sp_realtime_group_source_wrapper" href="http://www.baidu.com/link?url=yME3SkFtKB-dwfScA8ApgPhX8mctv0AXALxiJNVmdqGx_6fzd_N0s_cFjV0RoinaDIlByE4JLHAvxWw2ggBZWK" target="_blank" >
                                <div class="op_sp_realtime_group_source">
                                                                                                                        <span>澎湃新闻</span>&nbsp;
                                                                                                                                                        <span class="op_sp_realtime_group_source_time">        1小时前</span>
                                                                    </div>
                            </a>
                        </div>
                    </div>
                                                                                                                                                                            
                                    <div class="c-row op_sp_realtime_group_gap">
                                                    <div class="c-span6 op_sp_realtime_group_img">
                                <a href="http://www.baidu.com/link?url=3Q2j_5uFTEn55cpztvo0MtWixBFsXj5x1VCwYwk5FxpPj28gue8GzQgBDri6DXcx1AgbF9KSi1RixBBPrBthYkt6qksCdj6NP1tYkCkP4cm" target="_blank">
                                    <img class="c-img c-img6" src="https://dss1.baidu.com/6ONXsjip0QIZ8tyhnq/it/u=1585320703,2133323650&fm=173&app=49&size=f242,162&n=0&g=0n&f=JPEG?s=1E0613645950565D1C3435DE0300D0B9&sec=1592839290&t=5a547ef4a4647574e8ffb5633f8703f1" style="height:80px;">
                                </a>
                            </div>
                                                <div class="op_sp_realtime_group_title">
                            <a class="op_sp_realtime_group_title_text" href="http://www.baidu.com/link?url=3Q2j_5uFTEn55cpztvo0MtWixBFsXj5x1VCwYwk5FxpPj28gue8GzQgBDri6DXcx1AgbF9KSi1RixBBPrBthYkt6qksCdj6NP1tYkCkP4cm" target="_blank" >
                                                                    时隔8年再度光临中国!<em>乘客坐飞机拍到日环食</em>,组...
                                                            </a>
                            <div class="op_sp_realtime_subabs">
                                                                    重庆观测到的日偏食 湖南耒阳观测到的日偏食 <em>乘客飞机上拍到</em>罕见<em>日环食</em> 有网友晒出视频,称乘客坐飞机时,拍到了罕见的<em>...</em>
                                                            </div>
                            <a class="op_sp_realtime_group_source_wrapper" href="http://www.baidu.com/link?url=3Q2j_5uFTEn55cpztvo0MtWixBFsXj5x1VCwYwk5FxpPj28gue8GzQgBDri6DXcx1AgbF9KSi1RixBBPrBthYkt6qksCdj6NP1tYkCkP4cm" target="_blank" >
                                <div class="op_sp_realtime_group_source">
                                                                            <span><img class="source-icon" src="https://cambrian-images.cdn.bcebos.com/b9279adf974b78d27201a0b34970c2a9_1549941228125394.jpeg@w_100,h_100" alt="" />北晚新视觉网</span>&nbsp;
                                                                                                                <span class="op_sp_realtime_group_source_time">        2小时前</span>
                                                                    </div>
                            </a>
                        </div>
                    </div>
                                    ...
                                    <div class="c-row ">
                                                    <div class="c-span6 op_sp_realtime_group_img">
                                <a href="http://www.baidu.com/link?url=3Q2j_5uFTEn55cpztvo0MtWixBFsXj5x1VCwYwk5FxpPj28gue8GzQgBDri6DXcxddxaTSF0x9ezWNzAttmgWetkNqB3u8hQv1wPYLhsMIy" target="_blank">
                                    <img class="c-img c-img6" src="https://dss1.baidu.com/6ONXsjip0QIZ8tyhnq/it/u=712991476,3494753050&fm=173&app=49&size=f242,162&n=0&g=0n&f=JPEG?s=7C7AA7566722430755DDFCFA0300F031&sec=1592839290&t=f38d88d0d1192532990105f7d13b060e" style="height:80px;">
                                </a>
                            </div>
                                                <div class="op_sp_realtime_group_title">
                            <a class="op_sp_realtime_group_title_text" href="http://www.baidu.com/link?url=3Q2j_5uFTEn55cpztvo0MtWixBFsXj5x1VCwYwk5FxpPj28gue8GzQgBDri6DXcxddxaTSF0x9ezWNzAttmgWetkNqB3u8hQv1wPYLhsMIy" target="_blank" >
                                                                    一起来看21世纪最美日环食,<em>乘客坐飞机拍到日环食</em>
                                                            </a>
                            <div class="op_sp_realtime_subabs">
                                                                    <em>日环食</em> 但是很可惜,有部分地区因为天气阴雨的原因,很多人在地面上就只能看到个寂寞了,但是也有不少幸运的<em>乘客坐飞机</em>时...
                                                            </div>
                            <a class="op_sp_realtime_group_source_wrapper" href="http://www.baidu.com/link?url=3Q2j_5uFTEn55cpztvo0MtWixBFsXj5x1VCwYwk5FxpPj28gue8GzQgBDri6DXcxddxaTSF0x9ezWNzAttmgWetkNqB3u8hQv1wPYLhsMIy" target="_blank" >
                                <div class="op_sp_realtime_group_source">
                                                                            <span><img class="source-icon" src="https://cambrian-images.cdn.bcebos.com/84d2ab55a5a42264fa7b58c8a413949c_1584022344975.jpeg@w_100,h_100" alt="" />yangying侃热点大事</span>&nbsp;
                                                                                                                <span class="op_sp_realtime_group_source_time">        1小时前</span>
                                                                    </div>
                            </a>
                        </div>
...
<div class="result-op c-container c-group c-group-bottom xpath-log"  srcid="4295"  id="3" tpl="short_video_pc" mu="http://3108.lightapp.baidu.com/%B3%CB%BF%CD%D7%F8%B7%C9%BB%FA%C5%C4%B5%BD%C8%D5%BB%B7%CA%B3" data-op="{'y':'F7FBCCFF'}" data-click="{'p1':'3','rsv_bdr':'','fm':'alop',rsv_stl:'0'}">
            
            <h3 class="t c-gap-bottom-small c-group-title">
                                                                                        <a href="/sf/vsearch?pd=video&tn=vsearch&lid=b25baac30001622f&ie=utf-8&rsv_pq=b25baac30001622f&wd=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&rsv_spt=5&rsv_t=b2b1rDSC9qtWtEAbc6%2FQkAJPUqslesPAVLb0HDwhx0UME5HVpYxzo4kxzNcmmap1ZBXI&rsv_bp=1&f=8" target="_blank">
                        视频
        </a>
...
<div class='op-short-video-pc c-gap-top-small'>
                                <div class='c-row op-short-video-pc-gap' style='margin-left: -10px;'>
                            <div class='c-span6 op-short-video-pc-img-container'>
                    <a target='_blank' href='https://baijiahao.baidu.com/s?id=1670109191944598337&wfr=content' class='op-short-video-pc-link' title='美翻!乘客坐飞机拍到日环食全过程 网友感叹:天庭神仙的视角'>
                        <img src='https://vdposter.bdstatic.com/65d9773eb0bbab25d20ee0e4876d4eb3.jpeg?x-bce-process=image/resize,m_fill,w_242,h_182/format,f_jpg/quality,Q_100' data-src='http://vdposter.bdstatic.com/65d9773eb0bbab25d20ee0e4876d4eb3.jpeg' title='美翻!乘客坐飞机拍到日环食全过程 网友感叹:天庭神仙的视角' data-click='{"url": "https://baijiahao.baidu.com/s?id=1670109191944598337&wfr=content"}' class='op-short-video-pc-img-group c-img c-img6'>
                        <img data-click='{"url": "https://baijiahao.baidu.com/s?id=1670109191944598337&wfr=content"}' src='data:image/png;base64,' class='op-short-video-pc-play-icon' title='美翻!乘客坐飞机拍到日环食全过程 网友感叹:天庭神仙的视角'>
                        <div class='op-short-video-pc-duration-wrap'>
                            00:56
                        </div>
                    </a>
                    <a target='_blank' href='https://baijiahao.baidu.com/s?id=1670109191944598337&wfr=content' title='美翻!乘客坐飞机拍到日环食全过程 网友感叹:天庭神仙的视角' class='op-short-video-pc-title c-gap-top-small'>
                        美翻!<em>乘客坐飞机拍到日环食</em>全过程 ...
                    </a>
                                            <div style='' class='op-short-video-pc-source op-short-video-pc-clamp1'>
                            好看视频
                        </div>
                                    </div>
                            <div class='c-span6 op-short-video-pc-img-container'>
                    <a target='_blank' href='https://baijiahao.baidu.com/s?id=1670096710820741917&wfr=content' class='op-short-video-pc-link' title='震撼!乘客坐飞机时拍到金日环食全程 光芒四射的太阳秒“变脸”'>
                        <img src='https://vdposter.bdstatic.com/b57d7e9af17ded7e089387328907dd86.jpeg?x-bce-process=image/resize,m_fill,w_242,h_182/format,f_jpg/quality,Q_100' data-src='http://vdposter.bdstatic.com/b57d7e9af17ded7e089387328907dd86.jpeg' title='震撼!乘客坐飞机时拍到金日环食全程 光芒四射的太阳秒“变脸”' data-click='{"url": "https://baijiahao.baidu.com/s?id=1670096710820741917&wfr=content"}' class='op-short-video-pc-img-group c-img c-img6'>
                        <img data-click='{"url": "https://baijiahao.baidu.com/s?id=1670096710820741917&wfr=content"}' src='data:image/png;base64,' class='op-short-video-pc-play-icon' title='震撼!乘客坐飞机时拍到金日环食全程 光芒四射的太阳秒“变脸”'>
                        <div class='op-short-video-pc-duration-wrap'>
                            00:38
                        </div>
                    </a>
                    <a target='_blank' href='https://baijiahao.baidu.com/s?id=1670096710820741917&wfr=content' title='震撼!乘客坐飞机时拍到金日环食全程 光芒四射的太阳秒“变脸”' class='op-short-video-pc-title c-gap-top-small'>
                        震撼!<em>乘客坐飞机</em>时<em>拍到</em>金<em>日环食</em>全...
                    </a>
                                            <div style='' class='op-short-video-pc-source op-short-video-pc-clamp1'>
                            好看视频
                        </div>
                            ...
                            <div class='c-span6 op-short-video-pc-img-container'>
                    <a target='_blank' href='http://video.tudou.com/v/XNDcyMTc3ODM0MA==.html' class='op-short-video-pc-link' title='壮观!乘客飞机上拍到罕见日环食 巨大圆形瞬间变成“金指环”'>
                        <img src='https://vdposter.bdstatic.com/1d085c8c1cec251de52e6404589d6395.jpeg?x-bce-process=image/resize,m_fill,w_242,h_182/format,f_jpg/quality,Q_100' data-src='http://vdposter.bdstatic.com/1d085c8c1cec251de52e6404589d6395.jpeg' title='壮观!乘客飞机上拍到罕见日环食 巨大圆形瞬间变成“金指环”' data-click='{"url": "http://video.tudou.com/v/XNDcyMTc3ODM0MA==.html"}' class='op-short-video-pc-img-group c-img c-img6'>
                        <img data-click='{"url": "http://video.tudou.com/v/XNDcyMTc3ODM0MA==.html"}' src='data:image/png;base64,' class='op-short-video-pc-play-icon' title='壮观!乘客飞机上拍到罕见日环食 巨大圆形瞬间变成“金指环”'>
                        <div class='op-short-video-pc-duration-wrap'>
                            00:42
                        </div>
                    </a>
                    <a target='_blank' href='http://video.tudou.com/v/XNDcyMTc3ODM0MA==.html' title='壮观!乘客飞机上拍到罕见日环食 巨大圆形瞬间变成“金指环”' class='op-short-video-pc-title c-gap-top-small'>
                        壮观!<em>乘客飞机</em>上<em>拍到</em>罕见<em>日环食</em> 巨...
                    </a>
                                            <div style='' class='op-short-video-pc-source op-short-video-pc-clamp1'>
                            土豆
                        </div>
                                    </div>
                            <div class='c-span6 op-short-video-pc-img-container c-span-last'>
                    <a target='_blank' href='https://baijiahao.baidu.com/s?id=1670103996978645604&wfr=content' class='op-short-video-pc-link' title='乘客飞机上拍到罕见日环食 巨大圆形阴影在云海上缓缓划过'>
                        <img src='https://vdposter.bdstatic.com/90ee7588604548eb04ce0479d8545568.jpeg?x-bce-process=image/resize,m_fill,w_242,h_182/format,f_jpg/quality,Q_100' data-src='http://vdposter.bdstatic.com/90ee7588604548eb04ce0479d8545568.jpeg' title='乘客飞机上拍到罕见日环食 巨大圆形阴影在云海上缓缓划过' data-click='{"url": "https://baijiahao.baidu.com/s?id=1670103996978645604&wfr=content"}' class='op-short-video-pc-img-group c-img c-img6'>
                        <img data-click='{"url": "https://baijiahao.baidu.com/s?id=1670103996978645604&wfr=content"}' src='data:image/png;base64,' class='op-short-video-pc-play-icon' title='乘客飞机上拍到罕见日环食 巨大圆形阴影在云海上缓缓划过'>
                        <div class='op-short-video-pc-duration-wrap'>
                            01:05
                        </div>
                    </a>
                    <a target='_blank' href='https://baijiahao.baidu.com/s?id=1670103996978645604&wfr=content' title='乘客飞机上拍到罕见日环食 巨大圆形阴影在云海上缓缓划过' class='op-short-video-pc-title c-gap-top-small'>
728\u4e91\u6d77\u4e0a\u7f13\u7f13\u5212\u8fc7","duration":"01:05","jumpUrl":"https:\/\/baijiahao.baidu.com\/s?id=1670103996978645604&wfr=content","source":"\u597d\u770b\u89c6\u9891","poster":"http:\/\/vdposter.bdstatic.com\/90ee7588604548eb04ce0479d8545568.jpeg","pubTime":"1592735364","playCount":"0","producer":"\u6b32\u63e1\u73ab\u7470\u5fc5\u53d7\u5176\u75db","desc":null,"hospital":"","orgnizationLevel":"","doctorLevel":"","doctorName":"","imgSrc":"https:\/\/vdposter.bdstatic.com\/90ee7588604548eb04ce0479d8545568.jpeg?x-bce-process=image\/resize,m_fill,w_242,h_182\/format,f_jpg\/quality,Q_100"}],
        lid: "b25baac30001622f"
    });
</script>
        ...
        <div><span class="c-showurl"> </span></div>
																																									...
																																									<div class="result c-container " id="4" srcid="1599" tpl="se_com_default"  data-click="{'rsv_bdr':'' }"  ><h3 class="t"><a
	        data-click="{
			'F':'778717EA',
			'F1':'9D63F1E4',
			'F2':'4CA6DE6B',
        ...
        href = "http://www.baidu.com/link?url=lb7DqO8PSYLQe2jYs8fhFqXB0YJb9sQDhfqUBGvlyztxrDhyhsykW5yb5P3isOU-_-UxvJqVWSak0J_R8uD-y3ghIvF4t-Z_tWF4cHizG8O"

		            target="_blank"
        
		>时隔8年再度光临中国!<em>乘客坐飞机拍到日环食</em>,组图看天幕大戏</a></h3><div class="c-row c-gap-top-small"><div class="general_image_pic c-span6"><a class="c-img6" style="height:75px"
          href="http://www.baidu.com/link?url=lb7DqO8PSYLQe2jYs8fhFqXB0YJb9sQDhfqUBGvlyztxrDhyhsykW5yb5P3isOU-_-UxvJqVWSak0J_R8uD-y3ghIvF4t-Z_tWF4cHizG8O"
                target="_blank"
      ><img class="c-img c-img6" src="https://dss0.baidu.com/6ONWsjip0QIZ8tyhnq/it/u=577581573,1993091084&fm=173&app=49&f=JPEG?w=312&h=208&s=1E0613645950525D1C3435DE0300D0B9"  style="height:75px;" /></a></div><div class="c-span18 c-span-last"><div class="c-abstract"><span class=" newTimeFactor_before_abs m">2小时前&nbsp;-&nbsp;</span>重庆观测到的日偏食 湖南耒阳观测到的日偏食 <em>乘客飞机上拍到</em>罕见<em>日环食</em> 有网友晒出视频,称乘客坐飞机时,拍到了罕见的<em>日环食</em>。 黑漆漆的天空 镶嵌着一枚金色的戒指...</div><div class="f13"><a target="_blank" href="http://www.baidu.com/link?url=lb7DqO8PSYLQe2jYs8fhFqXB0YJb9sQDhfqUBGvlyztxrDhyhsykW5yb5P3isOU-_-UxvJqVWSak0J_R8uD-y3ghIvF4t-Z_tWF4cHizG8O" class="c-showurl" style="text-decoration:none;"><style>.nor-src-wrap {position: relative;}
...
.nor-src-icon-v.vicon-3 {background-image: url(https://b.bdstatic.com/searchbox/icms/searchbox/img/yellow-v.png);}</style><span class="nor-src-wrap"><img class="nor-src-icon nor-src-icon-with-v" src="https://cambrian-images.cdn.bcebos.com/a51d142ac7625feda1002f0c739ae255_1606863438588053.jpeg@w_100,h_100"><span class="nor-src-icon-v vicon-2"></span>潇湘晨报</span></a><div class="c-tools" id="tools_2874104549121338760_4" data-tools='{"title":"时隔8年再度光临中国!乘客坐飞机拍到日环食,组图看天幕大戏","url":"http://www.baidu.com/link?url=lb7DqO8PSYLQe2jYs8fhFqXB0YJb9sQDhfqUBGvlyztxrDhyhsykW5yb5P3isOU-_-UxvJqVWSak0J_R8uD-y3ghIvF4t-Z_tWF4cHizG8O"}'><a class="c-tip-icon"><i class="c-icon c-icon-triangle-down-g"></i></a></div><span class="c-icons-outer"><span class="c-icons-inner"></span></span>&nbsp;-&nbsp;<a data-click="{'rsv_snapshot':'1'}" href="http://cache.baiducontent.com/c?m=&p
44324b9d71fd325001c1b69e3b823281603d4c6786c15e9241dbdb239256b5572adc1&user=baidu&fm=sc&query=%B3%CB%BF%CD%D7%F8%B7%C9%BB%FA%C5%C4%B5%BD%C8%D5%BB%B7%CA%B3&qid=b25baac30001622f&p1=9"
                        target="_blank"
                    class="m">百度快照</a></div></div>
																																									...
																																									<div class="result c-container " id="10" srcid="1599" tpl="se_com_default"  data-click="{'rsv_bdr':'' }"  ><h3 class="t"><a
	        data-click="{
			'F':'778717EA',
			'F1':'9D63F1E4',
			'F2':'4CA6DE6B',
        ...
        href = "http://www.baidu.com/link?url=U-OpYfEevXV5dN1WRN8AvZkV9g4WDWKcMJxYzf265QnF1vn-uK8F3Q3AgIUQ_p23savYtMb_w6yyV6LBAEpvyK"

		            target="_blank"
        
		>美翻!<em>乘客坐飞机拍到日环食</em>全过程 网友感叹:天庭神仙的视角</a></h3><div class="c-abstract"><span class=" newTimeFactor_before_abs m">1小时前&nbsp;-&nbsp;</span>美翻!<em>乘客坐飞机拍到日环食</em>全过程 网友感叹:天庭神仙的视角 返回搜狐,查看更多 责任编辑:声明:该文观点仅代表作者本人,搜狐号系信息发布平台,搜狐仅提...</div><div class="f13"><a target="_blank" href="http://www.baidu.com/link?url=U-OpYfEevXV5dN1WRN8AvZkV9g4WDWKcMJxYzf265QnF1vn-uK8F3Q3AgIUQ_p23savYtMb_w6yyV6LBAEpvyK" class="c-showurl" style="text-decoration:none;"><style>.nor-src-wrap {position: relative;}
.nor-src-icon {vertical-align: middle;width: 14px;height: 14px;border: 1px solid #eee;border-radius: 100%;margin-right: 5px;margin-top: -3px;position: relative;}
.nor-src-icon-with-v {margin-right: 10px;}
.nor-src-icon-v {display: inline-block;width: 10px;height: 10px;border-radius: 100%;position: absolute;left: 8px;bottom: 0;background-image: url(https://b.bdstatic.com/searchbox/icms/searchbox/img/yellow-v.png);background-size: 10px 10px;}
.nor-src-icon-v.vicon-1 {background-image: url(https://b.bdstatic.com/searchbox/icms/searchbox/img/red-v.png);}
.nor-src-icon-v.vicon-2 {background-image: url(https://b.bdstatic.com/searchbox/icms/searchbox/img/blue-v.png);}
.nor-src-icon-v.vicon-3 {background-image: url(https://b.bdstatic.com/searchbox/icms/searchbox/img/yellow-v.png);}</style><span class="nor-src-wrap"><img class="nor-src-icon" src="https://timg01.bdimg.com/timg?pacompress=&amp;imgtype=0&amp;sec=1439619614&amp;autorotate=1&amp;di=45b00e4172635b0c418b72477c38e5c4&amp;quality=90&amp;size=b870_10000&amp;src=http%3A%2F%2Fpic.rmb.bdstatic.com%2Feab014be45108fa8ab9580e993530dd0.png">搜狐网</span></a><div class="c-tools" id="tools_1607800433317390091_10" data-tools='{"title":"美翻!乘客坐飞机拍到日环食全过程 网友感叹:天庭神仙的视角","url":"http://www.baidu.com/link?url=U-OpYfEevXV5dN1WRN8AvZkV9g4WDWKcMJxYzf265QnF1vn-uK8F3Q3AgIUQ_p23savYtMb_w6yyV6LBAEpvyK"}'><a class="c-tip-icon"><i class="c-icon c-icon-triangle-down-g"></i></a></div><span class="c-icons-outer"><span class="c-icons-inner"></span></span>&nbsp;-&nbsp;<a data-click="{'rsv_snapshot':'1'}" href="http://cache.baiducontent.com/c?m=&p=9960d616d9c109f14ebd9b7d0d7a&newp=9e759a46d69212a05aabcd39514b92695912c10e36d3c44324b9d71fd325001c1b69e3b823281603d4c6786c15e9241dbdb239256b5571&user=baidu&fm=sc&query=%B3%CB%BF%CD%D7%F8%B7%C9%BB%FA%C5%C4%B5%BD%C8%D5%BB%B7%CA%B3&qid=b25baac30001622f&p1=10"
                        target="_blank"
                    class="m">百度快照</a></div></div>
																																									...
																																									<div class="result c-container " id="11" srcid="1599" tpl="se_com_default"  data-click="{'rsv_bdr':'' }"  ><h3 class="t"><a
	        data-click="{
			'F':'778717EA',
			'F1':'9D63F1E4',
			'F2':'4CA6DE6B',
        ...
        href = "http://www.baidu.com/link?url=htQji6K1c8B4c3qzRB8TNH5QgokG2KotczE6ZyYuEuPyj9nuuv5hSCK3eiQX3lq6YB_Dv838BG8nOeurIlKsd_"

		            target="_blank"
        
		><em>乘客坐飞机拍到日环食</em> 2020日环食各地观测时间</a></h3><div class="c-row c-gap-top-small"><div class="general_image_pic c-span6"><a class="c-img6" style="height:75px"
          href="http://www.baidu.com/link?url=htQji6K1c8B4c3qzRB8TNH5QgokG2KotczE6ZyYuEuPyj9nuuv5hSCK3eiQX3lq6YB_Dv838BG8nOeurIlKsd_"
                target="_blank"
      ><img class="c-img c-img6" src="https://dss0.bdstatic.com/6Ox1bjeh1BF3odCf/it/u=3469155436,2426035963&fm=85&app=2&f=JPEG?w=121&h=75&s=35B4CB3549AA7336C633C1DD0300C0B0"  style="height:75px;" /></a></div><div class="c-span18 c-span-last"><div class="c-abstract"><span class=" newTimeFactor_before_abs m">5小时前&nbsp;-&nbsp;</span><em>乘客坐飞机拍到日环食</em>,今天是夏至日,让大家非常期待的日环食也在今天发生,有乘客就在乘坐飞机时拍摄到了日环食的景象,画面非常震撼美丽,那么2020日...</div><div class="f13"><a target="_blank" href="http://www.baidu.com/link?url=htQji6K1c8B4c3qzRB8TNH5QgokG2KotczE6ZyYuEuPyj9nuuv5hSCK3eiQX3lq6YB_Dv838BG8nOeurIlKsd_" class="c-showurl" style="text-decoration:none;"><style>.nor-src-wrap {position: relative;}
.nor-src-icon {vertical-align: middle;width: 14px;height: 14px;border: 1px solid #eee;border-radius: 100%;margin-right: 5px;margin-top: -3px;position: relative;}
.nor-src-icon-with-v {margin-right: 10px;}
.nor-src-icon-v {display: inline-block;width: 10px;height: 10px;border-radius: 100%;position: absolute;left: 8px;bottom: 0;background-image: url(https://b.bdstatic.com/searchbox/icms/searchbox/img/yellow-v.png);background-size: 10px 10px;}
.nor-src-icon-v.vicon-1 {background-image: url(https://b.bdstatic.com/searchbox/icms/searchbox/img/red-v.png);}
.nor-src-icon-v.vicon-2 {background-image: url(https://b.bdstatic.com/searchbox/icms/searchbox/img/blue-v.png);}
.nor-src-icon-v.vicon-3 {background-image: url(https://b.bdstatic.com/searchbox/icms/searchbox/img/yellow-v.png);}</style><span class="nor-src-wrap"><img class="nor-src-icon" src="https://timg01.bdimg.com/timg?pacompress=&amp;imgtype=0&amp;sec=1439619614&amp;di=8d123c13a137eb7a16c122cb8a1a9b82&amp;quality=90&amp;size=b870_10000&amp;src=http%3A%2F%2Fpic.rmb.bdstatic.com%2F588380dc8fbdc72787e8b778dd2d0fc6.jpeg">face妆点娱乐</span></a><div class="c-tools" id="tools_4780279613571813587_11" data-tools='{"title":"乘客坐飞机拍到日环食 2020日环食各地观测时间","url":"http://www.baidu.com/link?url=htQji6K1c8B4c3qzRB8TNH5QgokG2KotczE6ZyYuEuPyj9nuuv5hSCK3eiQX3lq6YB_Dv838BG8nOeurIlKsd_"}'><a class="c-tip-icon"><i class="c-icon c-icon-triangle-down-g"></i></a></div><span class="c-icons-outer"><span class="c-icons-inner"></span></span>&nbsp;-&nbsp;<a data-click="{'rsv_snapshot':'1'}" href="http://cache.baiducontent.com/c?m=&p=89759a45d5d218fb4ebe9b7c4c0a&newp=936c8916d9c11fff57ed97124a4492695912c10e37d0c44324b9d71fd325001c1b69e3b823281603d4c6786c15e9241dbdb239256b557e&user=baidu&fm=sc&query=%B3%CB%BF%CD%D7%F8%B7%C9%BB%FA%C5%C4%B5%BD%C8%D5%BB%B7%CA%B3&qid=b25baac30001622f&p1=11"
                        target="_blank"
                    class="m">百度快照</a></div></div></div></div>
																																									...
																																									<div class="result c-container " id="12" srcid="1599" tpl="se_com_default"  data-click="{'rsv_bdr':'' }"  ><h3 class="t"><a
	        data-click="{
			'F':'778F37E8',
			'F1':'9D63F1E4',
			'F2':'4CA6DD6B',
        ...
        href = "http://www.baidu.com/link?url=UEUKhs0LlHOXR9XuqnZb37-gWux7zKwn9NiJU_BfJ1LAM8uAOBBUF0yrE2EQdc5ywvU0CgjBPT6Rt0xs431yV_"

		            target="_blank"
        
f=1&oq=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&tn=baiduhome_pg&ie=utf-8&usm=1&rsv_idx=2&rsv_pq=b25baac30001622f&rsv_t=50e8ML8PbnAy7W1GkvRzxbllEpBZvf2cXtag94mQrAMLs6XQ4IHgGBOhMBUXpqJdlB1H&rqlang=cn&rs_src=0&rsv_pq=b25baac30001622f&rsv_t=50e8ML8PbnAy7W1GkvRzxbllEpBZvf2cXtag94mQrAMLs6XQ4IHgGBOhMBUXpqJdlB1H">单反拍日环食</a></th><td></td><th><a href="/s?wd=%E5%8D%95%E5%8F%8D%E6%80%8E%E4%B9%88%E6%8B%8D%E6%97%A5%E7%8E%AF%E9%A3%9F&rsf=62050020&rsp=7&f=1&oq=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&tn=baiduhome_pg&ie=utf-8&usm=1&rsv_idx=2&rsv_pq=b25baac30001622f&rsv_t=50e8ML8PbnAy7W1GkvRzxbllEpBZvf2cXtag94mQrAMLs6XQ4IHgGBOhMBUXpqJdlB1H&rqlang=cn&rs_src=0&rsv_pq=b25baac30001622f&rsv_t=50e8ML8PbnAy7W1GkvRzxbllEpBZvf2cXtag94mQrAMLs6XQ4IHgGBOhMBUXpqJdlB1H">单反怎么拍日环食</a></th><td></td><th><a href="/s?wd=%E7%94%A8%E6%89%8B%E6%9C%BA%E5%8F%AF%E4%BB%A5%E6%8B%8D%E6%97%A5%E7%8E%AF%E9%A3%9F%E5%90%97&rsf=62050020&rsp=8&f=1&oq=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&tn=baiduhome_pg&ie=utf-8&usm=1&rsv_idx=2&rsv_pq=b25baac30001622f&rsv_t=50e8ML8PbnAy7W1GkvRzxbllEpBZvf2cXtag94mQrAMLs6XQ4IHgGBOhMBUXpqJdlB1H&rqlang=cn&rs_src=0&rsv_pq=b25baac30001622f&rsv_t=50e8ML8PbnAy7W1GkvRzxbllEpBZvf2cXtag94mQrAMLs6XQ4IHgGBOhMBUXpqJdlB1H">用手机可以拍日环食吗</a></th></tr></table></div>	
					<div id="page" >
														<strong><span class="fk fk_cur"><i class="c-icon c-icon-bear-p"></i></span><span class="pc">1</span></strong><a href="/s?wd=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&pn=10&oq=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&tn=baiduhome_pg&ie=utf-8&usm=1&rsv_idx=2&rsv_pq=b25baac30001622f&rsv_t=50e8ML8PbnAy7W1GkvRzxbllEpBZvf2cXtag94mQrAMLs6XQ4IHgGBOhMBUXpqJdlB1H"><span class="fk fkd"><i class="c-icon c-icon-bear-pn"></i></span><span class="pc">2</span></a><a href="/s?wd=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&pn=20&oq=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&tn=baiduhome_pg&ie=utf-8&usm=1&rsv_idx=2&rsv_pq=b25baac30001622f&rsv_t=50e8ML8PbnAy7W1GkvRzxbllEpBZvf2cXtag94mQrAMLs6XQ4IHgGBOhMBUXpqJdlB1H"><span class="fk"><i class="c-icon c-icon-bear-pn"></i></span><span class="pc">3</span></a><a href="/s?wd=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&pn=30&oq=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&tn=baiduhome_pg&ie=utf-8&usm=1&rsv_idx=2&rsv_pq=b25baac30001622f&rsv_t=50e8ML8PbnAy7W1GkvRzxbllEpBZvf2cXtag94mQrAMLs6XQ4IHgGBOhMBUXpqJdlB1H"><span class="fk fkd"><i class="c-icon c-icon-bear-pn"></i></span><span class="pc">4</span></a><a href="/s?wd=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&pn=40&oq=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&tn=baiduhome_pg&ie=utf-8&usm=1&rsv_idx=2&rsv_pq=b25baac30001622f&rsv_t=50e8ML8PbnAy7W1GkvRzxbllEpBZvf2cXtag94mQrAMLs6XQ4IHgGBOhMBUXpqJdlB1H"><span class="fk"><i class="c-icon c-icon-bear-pn"></i></span><span class="pc">5</span></a><a href="/s?wd=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&pn=50&oq=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&tn=baiduhome_pg&ie=utf-8&usm=1&rsv_idx=2&rsv_pq=b25baac30001622f&rsv_t=50e8ML8PbnAy7W1GkvRzxbllEpBZvf2cXtag94mQrAMLs6XQ4IHgGBOhMBUXpqJdlB1H"><span class="fk fkd"><i class="c-icon c-icon-bear-pn"></i></span><span class="pc">6</span></a><a href="/s?wd=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&pn=60&oq=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&tn=baiduhome_pg&ie=utf-8&usm=1&rsv_idx=2&rsv_pq=b25baac30001622f&rsv_t=50e8ML8PbnAy7W1GkvRzxbllEpBZvf2cXtag94mQrAMLs6XQ4IHgGBOhMBUXpqJdlB1H"><span class="fk"><i class="c-icon c-icon-bear-pn"></i></span><span class="pc">7</span></a><a href="/s?wd=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&pn=70&oq=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&tn=baiduhome_pg&ie=utf-8&usm=1&rsv_idx=2&rsv_pq=b25baac30001622f&rsv_t=50e8ML8PbnAy7W1GkvRzxbllEpBZvf2cXtag94mQrAMLs6XQ4IHgGBOhMBUXpqJdlB1H"><span class="fk fkd"><i class="c-icon c-icon-bear-pn"></i></span><span class="pc">8</span></a><a href="/s?wd=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&pn=80&oq=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&tn=baiduhome_pg&ie=utf-8&usm=1&rsv_idx=2&rsv_pq=b25baac30001622f&rsv_t=50e8ML8PbnAy7W1GkvRzxbllEpBZvf2cXtag94mQrAMLs6XQ4IHgGBOhMBUXpqJdlB1H"><span class="fk"><i class="c-icon c-icon-bear-pn"></i></span><span class="pc">9</span></a><a href="/s?wd=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&pn=90&oq=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&tn=baiduhome_pg&ie=utf-8&usm=1&rsv_idx=2&rsv_pq=b25baac30001622f&rsv_t=50e8ML8PbnAy7W1GkvRzxbllEpBZvf2cXtag94mQrAMLs6XQ4IHgGBOhMBUXpqJdlB1H"><span class="fk fkd"><i class="c-icon c-icon-bear-pn"></i></span><span class="pc">10</span></a><a href="/s?wd=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&pn=10&oq=%E4%B9%98%E5%AE%A2%E5%9D%90%E9%A3%9E%E6%9C%BA%E6%8B%8D%E5%88%B0%E6%97%A5%E7%8E%AF%E9%A3%9F&tn=baiduhome_pg&ie=utf-8&usm=1&rsv_idx=2&rsv_pq=b25baac30001622f&rsv_t=50e8ML8PbnAy7W1GkvRzxbllEpBZvf2cXtag94mQrAMLs6XQ4IHgGBOhMBUXpqJdlB1H&rsv_page=1" class="n">下一页&gt;</a>
							</div>
...
bds&&bds.comm&&(bds.comm.supportis=!i,bds.comm.isui=!0),window.__restart_confirm_timeout=!0,window.__confirm_timeout=8e3,window.__disable_is_guide=!0,window.__disable_swap_to_empty=!0,window.__switch_add_mask=!0;var s="https://dss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/global/js/all_async_search_bb6b98f.js",n="/script";document.write("<script src='"+s+"'><"+n+">"),bds.comm.newindex&&$(window).on("index_off",function(){$('<div class="c-tips-container" id="c-tips-container"></div>').insertAfter("#wrapper"),window.__sample_dynamic_tab&&$("#s_tab").remove()
	...
	<script>
    A.merge("timeliness_news2",function(){A.setup(function(){function stopAnimate(){_this.find(".op-timeliness-inner:animated").stop()}function stop(){window.clearTimeout(timer),timer=null,window.clearTimeout(timer2),timer2=null,animatingflag=false}function start(){timer2=window.setTimeout(automove,2e3)}function automove(){if(num++,4==num)num=1,oInner.css("left","0");if(!animatingflag){for(var i=0;i<oLis.length;i++){var oFirstA5=oLis.eq(i).find("a:first");oFirstA5.removeClass("c-icon-circle-blue").addClass("c-icon-circle-gray")}if(3==num){var oFirstA4=oLis.eq(0).find("a:first");oFirstA4.removeClass("c-icon-circle-gray").addClass("c-icon-circle-blue")}else{var oFirstA3=oLis.eq(num).find("a:first");oFirstA3.removeClass("c-icon-circle-gray").addClass("c-icon-circle-blue")}animatingflag=true,oInner.animate({left:-320*num},"slow",function(){animatingflag=false,timer=window.setTimeout(function(){automove()},4e3)})}}function init(conts){var $obj=$(conts).find(".op_timeliness_news_title a").length?$(conts).find(".op_timeliness_news_title a"):$(conts).find(".op-timeline-news2-subtitle a");_this.sh_fav_obj={url:$obj.attr("href"),title:$obj.html()};var $conts=$(conts);oLis=$conts.find(".op-timeliness-btn li");var oDivContainer=$conts.find(".op-timeliness-outer");oInner=$conts.find(".op-timeliness-inner");var oDivs=$conts.find(".op-timeliness-inner>div");oCopy=oInner.find("div:first").clone(true);var oLeft=$conts.find(".op-timeliness-left"),oRight=$conts.find(".op-timeliness-right");oInner.append(oCopy),oInner.css("width","1280px"),oDivs.each(function(i,n){$(n).find("img").css({width:"320px",height:"160px",overflow:"hidden"})});for(var i=0;i<oLis.length;i++){oLis.eq(i).attr("index",i);var oFirstA5=oLis.eq(i).find("a:first");oFirstA5.removeClass("c-icon-circle-blue").addClass("c-icon-circle-gray");var oFirstA=oLis.eq(0).find("a:first");oFirstA.removeClass("c-icon-circle-gray").addClass("c-icon-circle-blue"),oLis.eq(i).bind("click",function(){if(!animatingflag){animatingflag=true,oInner.animate({left:-320*$(this).attr("index")},"slow",function(){animatingflag=false
}),num=$(this).attr("index");for(var i=0;i<oLis.length;i++){var oFirstA5=oLis.eq(i).find("a:first");oFirstA5.removeClass("c-icon-circle-blue").addClass("c-icon-circle-gray")}var oFirstA2=$(this).find("a:first");oFirstA2.removeClass("c-icon-circle-gray").addClass("c-icon-circle-blue")}})}if(oRight.bind("click",function(){if(!animatingflag){if(num++,4==num)num=1,oInner.css("left","0");animatingflag=true,oInner.animate({left:-320*num},"slow",function(){animatingflag=false});for(var i=0;i<oLis.length;i++){var oFirstA5=oLis.eq(i).find("a:first");oFirstA5.removeClass("c-icon-circle-blue").addClass("c-icon-circle-gray")}if(3==num){var oFirstA4=oLis.eq(0).find("a:first");oFirstA4.removeClass("c-icon-circle-gray").addClass("c-icon-circle-blue")}else{var oFirstA3=oLis.eq(num).find("a:first");oFirstA3.removeClass("c-icon-circle-gray").addClass("c-icon-circle-blue")}}}),1==autorun)start(),oDivContainer.bind("mouseenter",function(e){stop()}),oDivContainer.bind("mouseleave",function(e){stop(),start()});oLeft.bind("click",function(){if(!animatingflag){if(num--,-1==num)num=2,oInner.css("left","-960px");animatingflag=true,oInner.animate({left:-320*num},"slow",function(){animatingflag=false});for(var i=0;i<oLis.length;i++){var oFirstA5=oLis.eq(i).find("a:first");oFirstA5.removeClass("c-icon-circle-blue").addClass("c-icon-circle-gray")}if(3==num){var oFirstA4=oLis.eq(2).find("a:first");oFirstA4.removeClass("c-icon-circle-gray").addClass("c-icon-circle-blue")}else{var oFirstA3=oLis.eq(num).find("a:first");oFirstA3.removeClass("c-icon-circle-gray").addClass("c-icon-circle-blue")}}})}var _this=this,timer=null,timer2=null,last=_this.data.last-1,animatingflag=false,oInner,num=0,oCopy,oLis,tabs,autorun=_this.data.autorun;if(_this.sh_fav_obj=null,_this.data.tabflag>1&&A.use("tabs5",function(){tabs=A.ui.tabs5(_this.find(".c-tabs")[0],{onChange:function(){if(tabs.current!=last){stopAnimate(),stop(),$(tabs.conts[tabs.last]).find(".op-timeliness-inner").css("left","0px"),num=0,oCopy.css("width","0"),oCopy.remove(),$(tabs.conts[tabs.last]).find(".op-timeliness-inner").css("width","960px"),$(tabs.conts[tabs.last]).find(".op-timeliness-left").unbind("click"),$(tabs.conts[tabs.last]).find(".op-timeliness-right").unbind("click");
for(var i=0;i<oLis.length;i++)oLis.eq(i).unbind("click");init(tabs.conts[tabs.current]),last=tabs.current;var $obj=$(tabs.conts[tabs.current]).find(".op_timeliness_news_title a").length?$(tabs.conts[tabs.current]).find(".op_timeliness_news_title a"):$(tabs.conts[tabs.current]).find(".op-timeline-news2-subtitle a");_this.sh_fav_obj={url:$obj.attr("href"),title:$obj.html()}}}}),init(tabs.conts[last])}),1==_this.data.tabflag){var wholeDom=_this.find(".c-tabs-content");init(wholeDom)}var videoArea=_this.find(".op-timeliness-click-area"),playButton=_this.find(".op-timeliness-video-play-icon"),video=_this.find(".op-timeliness-video");playButton.bind("click",function(){video.css("display","block"),videoArea.css("display","none"),video.trigger("play")}),this.dispose=function(){window.clearTimeout(timer),window.clearTimeout(timer2),tabs&&tabs.dispose&&tabs.dispose()}});});A.merge("short_video_pc",function(){A.init(function(){function getLogHost(){return"http:"===location.protocol?"http://sestat.baidu.com/mwb2.gif":"https://sp1.baidu.com/5b1ZeDe5KgQFm2e88IuM_a/mwb2.gif"}function hitSample(){return config.curSample}function updateSample(){if(!config.curSample)config.curSample=Math.random()<config.sample?1:0}function stringify(data){var res=[];for(var key in data){var value=data[key];if("undefined"===typeof value)value="";else if("string"!==typeof value)value=JSON.stringify(value);res.push(encodeURIComponent(key)+"="+encodeURIComponent(value))}return res.join("&")}function checkImgSize(img){var imgWidth=img.naturalWidth||img.width,imgHeight=img.naturalHeight||img.height;if(imgWidth<10||imgHeight<10)return false;else return true}function sendImgLog(imgSrc){if(!imgSrc)return false;var img=new Image;if(img.onload=function(){if(!checkImgSize(this))sendLog(imgSrc,"mini_size");img.onload=img.onerror=null},img.onerror=function(){sendLog(imgSrc,"error"),img.onload=img.onerror=null},img.src=imgSrc,img.complete)img.onload();_this.dispose=function(){img.onload=img.onerror=null}}function sendLog(imgSrc,errorType){if(hitSample()){var uaInfo=uaMatch(),data={pid:"1_5",lid:_this.data.lid,ts:Date.now(),type:"et_comm",info:{src:imgSrc,msg:"img_error"},ext:{path:location.pathname},dim:{pd:"video",pos:"short_video_pc",browser:uaInfo.name,system:uaInfo.platform,errorType:errorType},group:"pc_imgloaderror"},img=new Image;img.src=getLogHost()+"?"+stringify(data)}}function uaMatch(){var ua=window.navigator.userAgent;ua=ua.toLowerCase();var match=/(edge)\/([\w.]+)/.exec(ua)||/(opr)[\/]([\w.]+)/.exec(ua)||/(chrome)[ \/]([\w.]+)/.exec(ua)||/(version)(applewebkit)[ \/]([\w.]+).*(safari)[ \/]([\w.]+)/.exec(ua)||/(webkit)[ \/]([\w.]+).*(version)[ \/]([\w.]+).*(safari)[ \/]([\w.]+)/.exec(ua)||/(webkit)[ \/]([\w.]+)/.exec(ua)||/(opera)(?:.*version|)[ \/]([\w.]+)/.exec(ua)||/(msie) ([\w.]+)/.exec(ua)||ua.indexOf("trident")>=0&&/(rv)(?::| )([\w.]+)/.exec(ua)||ua.indexOf("compatible")<0&&/(mozilla)(?:.*? rv:([\w.]+)|)/.exec(ua)||[],platform_match=/(ipad)/.exec(ua)||/(win)/.exec(ua)||/(mac)/.exec(ua)||/(linux)/.exec(ua)||/(cros)/.exec(ua)||[],browser={},matched={browser:match[5]||match[3]||match[1]||"",platform:platform_match[0]||""};
if(matched.browser)browser[matched.browser]=true;if(browser.rv)matched.browser="msie";else if(browser.edge)matched.browser="msedge";else if(browser.opr)matched.browser="opera";return browser.name=matched.browser||"other",browser.platform=matched.platform||"other",browser}var _this=this;if(_this.data.videoList&&_this.data.videoList.length){var config={sample:.01};if(-1!==document.cookie.indexOf("webbtest=1"))config.sample=1;updateSample(),_this.data.videoList.forEach(function(video){sendImgLog(video.imgSrc)})}});});A.merge("right_toplist1",function(){A.setup(function(){var _this=this,$tb=_this.find("tbody"),$refresh=_this.find(".opr-toplist1-refresh"),$a=_this.find(".FYB_RD tbody a"),currentPage=0;if(_this.data.num>0)$refresh.on("click",function(e){if(currentPage<_this.data.num-1)++currentPage;else currentPage=0;$tb.hide(),$tb.eq(currentPage).show(),e.preventDefault()});$a.each(function(i){$a.eq(i).attr("href",$a.eq(i).attr("href")+"&rqid="+window.bds.comm.qid)});var pn=15,reRender=function(){var $tr=_this.find("tr"),reg=new RegExp("(^|&)rsf=([^&]*)","i");$tb.each(function(i){$tb.eq(i).html($tr.slice(i*pn,Math.min((i+1)*pn),$tr.length-i*pn))}),_this.data.num=Math.ceil($tr.length/pn),$a.each(function(i){var new_href=$a.eq(i).attr("href").replace(reg,function(value){var valueArr=value.slice(5).split("_");if(valueArr[3]%15==0)valueArr[1]=valueArr[3]-14,valueArr[2]=valueArr[3];else if(valueArr[1]=valueArr[3]-valueArr[3]%15+1,valueArr[2]=valueArr[3]-valueArr[3]%15+15,valueArr[2]>$a.length)valueArr[2]=$a.length;return"&rsf="+valueArr.join("_")});$a.eq(i).attr("href",new_href)})};$(window).on("swap_end",function(e,cacheItem){if(1===$("#con-ar").children(".result-op").length)reRender()})});});
...
(function () {
    bds.amd.addConfig({"paths":{"search-ui/v2/core":"//www.baidu.com/cache/atom/search-ui/v2/core_4f18d6d","search-ui/v2/few":"//www.baidu.com/cache/atom/search-ui/v2/few_708d2f8","search-ui/v2/enhance":"//www.baidu.com/cache/atom/search-ui/v2/enhance_cd0044d"},"bundles":{"search-ui/v2/core":["search-ui/v2/Aladdin/Aladdin","search-ui/v2/Button/BtnLayout","search-ui/v2/Button/Button","search-ui/v2/Divider/Divider","search-ui/v2/Footer/Footer","search-ui/v2/Footer/MipIcon","search-ui/v2/Icon/Icon","search-ui/v2/Image/Image","search-ui/v2/Image/ImageMask","search-ui/v2/KgFooter/KgFooter","search-ui/v2/KgHeader/KgHeader","search-ui/v2/Label/Label","search-ui/v2/Line/Line","search-ui/v2/Link/Link","search-ui/v2/List/List","search-ui/v2/List/ListItem","search-ui/v2/Loading/Loading","search-ui/v2/More/More","search-ui/v2/Navs/ListMore","search-ui/v2/Navs/Navs","search-ui/v2/Navs/NavsCommon","search-ui/v2/Navs/NavsScroll","search-ui/v2/Row/Row","search-ui/v2/Row/Span","search-ui/v2/Scroll/Scroll","search-ui/v2/Scroll/ScrollAuto","search-ui/v2/Scroll/ScrollInner","search-ui/v2/Scroll/ScrollItem","search-ui/v2/Share/Share","search-ui/v2/Sigma/Sigma","search-ui/v2/Sigma/SigmaFooter","search-ui/v2/Slink/Slink","search-ui/v2/Tabs/Tabs","search-ui/v2/Tabs/TabsContent","search-ui/v2/Tabs/TabsItem","search-ui/v2/TextLine/TextLine","search-ui/v2/Timespan/Timespan","search-ui/v2/Title/Title","search-ui/v2/Title/TitleBase","search-ui/v2/TouchableFeedback/TouchableFeedback","search-ui/v2/TouchableFeedback/TouchableStop","search-ui/v2/util/async","search-ui/v2/util/deviceUtil","search-ui/v2/util/domUtil","search-ui/v2/util/orientationMixin","search-ui/v2/util/stopIOSDoubleTapMixin","search-ui/v2/util/stopScrollThroughMixin","search-ui/v2/TooltipFuncBtn/TooltipFuncBtn","search-ui/v2/Tooltip/Tooltip","search-ui/v2/Popup/Popup","search-ui/v2/Motion/Transition","search-ui/v2/Motion/animations","search-ui/v2/Toast/Toast","search-ui/v2/Toast/ToastPopup"],"search-ui/v2/few":["search-ui/v2/Calendar/Calendar","search-ui/v2/Calendar/CalendarMonthItem","search-ui/v2/Calendar/Mask","search-ui/v2/Carousel/Carousel","search-ui/v2/Carousel/CarouselFrame","search-ui/v2/Carousel/CarouselItem","search-ui/v2/Carousel/Indicator","search-ui/v2/Cascader/Cascader","search-ui/v2/ErrorPage/ErrorPage","search-ui/v2/FilterEnhanced/BottomLayout","search-ui/v2/FilterEnhanced/Checkbox","search-ui/v2/FilterEnhanced/CustomLayout","search-ui/v2/FilterEnhanced/Filter","search-ui/v2/FilterEnhanced/FilterEnhanced","search-ui/v2/FilterEnhanced/FilterFrame","search-ui/v2/FilterEnhanced/ListLayout","search-ui/v2/FilterEnhanced/Mask","search-ui/v2/FilterEnhanced/MultiCheckbox","search-ui/v2/FilterEnhanced/MultiLayout","search-ui/v2/FilterEnhanced/MultiRangeInput","search-ui/v2/FilterEnhanced/store","search-ui/v2/FilterEnhanced/TagLayout","search-ui/v2/ImageViewer/asset/js/animate-config","search-ui/v2/ImageViewer/asset/js/animate","search-ui/v2/ImageViewer/asset/js/link","search-ui/v2/ImageViewer/asset/js/store","search-ui/v2/ImageViewer/asset/js/touch-helper","search-ui/v2/ImageViewer/asset/js/util","search-ui/v2/ImageViewer/ImageViewer","search-ui/v2/ImageViewer/ImageViewerClose","search-ui/v2/ImageViewer/ImageViewerContent","search-ui/v2/ImageViewer/ImageViewerImg","search-ui/v2/ImageViewer/ImageViewerInfo","search-ui/v2/ImageViewer/ImageViewerItem","search-ui/v2/ImageViewer/ImageViewerZoom","search-ui/v2/Tombstone/ImgTombstone","search-ui/v2/Tombstone/ImgTombstoneItem","search-ui/v2/Tombstone/Tombstone","search-ui/v2/Tombstone/TombstoneItem","search-ui/v2/Waterfall/ImgItem","search-ui/v2/Waterfall/Waterfall"],"search-ui/v2/enhance":["search-ui/v2/AnimateIcon/Arrow","search-ui/v2/AnimateIcon/Triangle","search-ui/v2/Article/Article","search-ui/v2/Article/ArticleExtInfo","search-ui/v2/Audio/Audio","search-ui/v2/Content/Content","search-ui/v2/Dialog/Dialog","search-ui/v2/Drawer/Drawer","search-ui/v2/Dropdown/Dropdown","search-ui/v2/Dropdown/DropdownEnhanced","search-ui/v2/Filter/Filter","search-ui/v2/Filter/FilterListPanel","search-ui/v2/Filter/FilterMultiListPanel","search-ui/v2/Filter/FilterNormal","search-ui/v2/Filter/FilterRangeInput","search-ui/v2/Filter/FilterThreeListPanel","search-ui/v2/Filter/FilterTwoListPanel","search-ui/v2/FilterSimple/FilterSimple","search-ui/v2/FilterSimple/FilterTagLayout","search-ui/v2/FilterSimple/FilterTagLayoutItem","search-ui/v2/ImageViewerSimple/Base","search-ui/v2/ImageViewerSimple/ImageViewerSimple","search-ui/v2/ImageViewerSimple/Toolbar","search-ui/v2/ImgContent/ImgContent","search-ui/v2/InfiniteScroll/InfiniteScroll","search-ui/v2/InfiniteScroll/InfiniteScrollBottomBar","search-ui/v2/Input/Input","search-ui/v2/Input/RangeInput","search-ui/v2/LetterSort/LetterSort","search-ui/v2/LetterSort/LetterSortToast","search-ui/v2/ListArticle/ListArticle","search-ui/v2/ListResult/ListResult","search-ui/v2/Lottie/Lottie","search-ui/v2/Mask/Mask","search-ui/v2/Motion/Animation","search-ui/v2/Motion/Flip","search-ui/v2/NewsArticle/NewsArticle","search-ui/v2/PageScroll/PageScroll","search-ui/v2/PageScroll/PageScrollItem","search-ui/v2/PageScrollImgs/PageScrollImgs","search-ui/v2/PageScrollImgs/PageScrollImgsItem","search-ui/v2/PageScrollVideo/PageScrollVideo","search-ui/v2/PullRefresh/PullRefresh","search-ui/v2/Rec/Rec","search-ui/v2/ScrollArticle/ScrollArticle","search-ui/v2/ScrollArticle/ScrollArticleItem","search-ui/v2/ScrollImgs/ScrollImgs","search-ui/v2/ScrollImgs/ScrollImgsItem","search-ui/v2/ScrollTwo/ScrollTwo","search-ui/v2/ScrollTwoFrame/ScrollTwoFrame","search-ui/v2/ScrollVideo/ScrollVideo","search-ui/v2/Selector/Selector","search-ui/v2/Selector/SelectorMulti","search-ui/v2/Selector/SelectorRadio","search-ui/v2/Source/Source","search-ui/v2/Spread/Spread","search-ui/v2/SpreadEnhanced/Spread","search-ui/v2/SpreadEnhanced/SpreadBottomBtn","search-ui/v2/SpreadEnhanced/SpreadEnhanced","search-ui/v2/SpreadEnhanced/SpreadRightBottomBtn","search-ui/v2/SpreadEnhanced/SpreadTopBtn","search-ui/v2/Stars/Stars","search-ui/v2/StitchImgs/StitchImgs","search-ui/v2/StitchImgs/StitchImgsFive","search-ui/v2/StitchImgs/StitchImgsRevertTwo","search-ui/v2/StitchImgs/StitchImgsThree","search-ui/v2/StitchImgs/StitchImgsTwo","search-ui/v2/StrongLink/StrongLink","search-ui/v2/Switch/Switch","search-ui/v2/Table/Table","search-ui/v2/TableGrid/TableGrid","search-ui/v2/TagGroup/TagGroup","search-ui/v2/Tags/SpreadTags","search-ui/v2/Tags/TagItem","search-ui/v2/Tags/Tags","search-ui/v2/Tags/TagsContent","search-ui/v2/Tags/TagsItem","search-ui/v2/Tags/TagsWrapper","search-ui/v2/ToTop/ToTop","search-ui/v2/Video/Video","search-ui/v2/Video/VideoCol","search-ui/v2/Video/VideoContent","search-ui/v2/Video/VideoThumbnail"]}});
		...
		<script type="text/javascript">_WWW_SRV_T =145.82;</script>
	
	

</html>
<!--cxy_ex+1592752890+3274892920+69ec59dcfdf31536efa06a025fea99cf--><!--cxy_all+baiduhome_pg+7b5263314b68af46862fde523e54644b+000000000000000000000000000000000333223-->
